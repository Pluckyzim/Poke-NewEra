...
class ScriptEnviroment
{
	public:
		...
		static bool getTempStorage(const std::string key, std::string& value);
		static void setTempStorage(const std::string key, const std::string& value) {m_tempStorageMap[key] = value;}
		static void eraseTempStorage(const std::string key) {m_tempStorageMap.erase(key);}
	...
	private:
		...
		typedef std::map<std::string, std::string> TempStorageMap;
		...
		static TempStorageMap m_tempStorageMap;
...
enum ErrorCode_t
{
	...
	LUA_ERROR_CHANNEL_NOT_FOUND,
	LUA_ERROR_TOURNAMENT_NOT_FOUND
};
...
class LuaScriptInterface
{
	...
	protected:
		...
		//PS NewPackets Start
		static int32_t luaDoPlayerSendPokemonSkills(lua_State* L);
		static int32_t luaDoPlayerSendPokemonSkillContainerClose(lua_State* L);
		static int32_t luaDoPlayerSendPokemonSkillContainerOpen(lua_State* L);
		//
		static int32_t luaDoPlayerSendPokemonWindowAddPokemonIcon(lua_State* L);
		static int32_t luaDoPlayerSendPokemonWindowRemovePokemonIcon(lua_State* L);
		static int32_t luaDoPlayerSendPokemonWindowUpdatePokemonIcon(lua_State* L);
		static int32_t luaDoPlayerSendPokemonWindowOpen(lua_State* L);
		static int32_t luaDoPlayerSendPokemonWindowClose(lua_State* L);
		//
		static int32_t luaDoPlayerSendPokemonSkillCooldown(lua_State* L);
		//
		static int32_t luaDoPlayerSendPokedexStatus(lua_State* L);
		static int32_t luaDoPlayerSendPokedexOpen(lua_State* L);
		static int32_t luaDoPlayerSendPokedexItemUpdate(lua_State* L);
		//PS NewPackets End
		...
		/*static int32_t luaDoCreateTile(lua_State* L); // PS*/
		...
		static int32_t luaGetMonsterSex(lua_State* L);
		static int32_t luaSetMonsterSex(lua_State* L);
		static int32_t luaGetMonsterLevel(lua_State* L);
		static int32_t luaSetMonsterLevel(lua_State* L);
		static int32_t luaSetMonsterExtraPoints(lua_State* L);
		static int32_t luaGetMonsterExtraPoints(lua_State* L);
		static int32_t luaGetMonsterExtraSpAtk(lua_State* L);
		static int32_t luaDoMonsterAddExtraSpAtk(lua_State* L);
		static int32_t luaGetMonsterExtraSpDef(lua_State* L);
		static int32_t luaDoMonsterAddExtraSpDef(lua_State* L);
		...
		static int32_t luaSetPlayerMagicLevel(lua_State* L);
		static int32_t luaSetPlayerMagicLevelPercent(lua_State* L);
		...
		static int32_t luaDoPlayerAddDepotItem(lua_State* L);
		static int32_t luaDoPlayerWriteItem(lua_State* L);
		static int32_t luaDoPlayerOpenContainer(lua_State* L);
		...
		static int32_t luaGetPlayerItemByIdWithAttribute(lua_State* L);
		static int32_t luaGetPlayerItemByAttribute(lua_State* L);
		...
		static int32_t luaGetTempStorage(lua_State* L);
		static int32_t luaSetTempStorage(lua_State* L);
		...
		static int32_t luaGetContainerItemByIndex(lua_State* L);
		...
		static int32_t luaSetItemUniqueOwner(lua_State* L);
		static int32_t luaGetCreatureLastPosition(lua_State* L);
		static int32_t luaGetCreatureName(lua_State* L);
		static int32_t luaGetCreatureNickname(lua_State* L);
		static int32_t luaSetCreatureNickname(lua_State* L);
		...
		static int32_t luaDoCreatureWalkToPosition(lua_State* L);
		static int32_t luaDoCreatureFollowCreature(lua_State* L);
		static int32_t luaGetCreatureFollowCreature(lua_State* L);
		...
		static int32_t luaDoMovePlayerItem(lua_State* L);
		static int32_t luaDoPlayerUseItem(lua_State* L);
		...
		static int32_t luaDoItemSetCount(lua_State* L);
		static int32_t luaDoItemEraseAttribute(lua_State* L);
		static int32_t luaDoItemSetSpecialDescription(lua_State* L);
		...
		static int32_t luaGetRandom(lua_State* L);
		static int32_t luaGetPlayerAutoTrade(lua_State* L);
		static int32_t luaSetPlayerAutoTrade(lua_State* L);
		static int32_t luaDoPlayerTalkOnChannel(lua_State* L);
		static int32_t luaDoPlayerSendChannelsDialog(lua_State* L);
		static int32_t luaDoPlayerJoinChannel(lua_State* L);
		static int32_t luaDoPlayerLeaveChannel(lua_State* L);
		static int32_t luaDoPlayerSendTVChannelsDialog(lua_State* L);
		static int32_t luaDoPlayerCreateTVChannel(lua_State* L);
		static int32_t luaDoPlayerDeleteTVChannel(lua_State* L);
		static int32_t luaGetPlayerRecordingTV(lua_State* L);
		static int32_t luaGetPlayerWatchingTV(lua_State* L);
		static int32_t luaGetPlayerTVChannelId(lua_State* L);
		static int32_t luaSetTVChannelName(lua_State* L);
		static int32_t luaGetTVChannelViewers(lua_State* L);
		static int32_t luaDoPlayerLeaveTVChannel(lua_State* L);
		static int32_t luaDoTVChannelBan(lua_State* L);
		static int32_t luaDoTVChannelUnban(lua_State* L);
		static int32_t luaGetPlayerDueling(lua_State* L);
		static int32_t luaGetPlayerDuelPokemonRemaing(lua_State* L);
		static int32_t luaSetPlayerDuelPokemonRemaing(lua_State* L);
		static int32_t luaGetPlayerPartyDuel(lua_State* L);
		static int32_t luaDoPartyDuelLeave(lua_State* L);
		static int32_t luaDoPartyDuelInvite(lua_State* L);
		static int32_t luaDoPartyDuelJoin(lua_State* L);
		static int32_t luaDoPartyDuelCreate(lua_State* L);
		static int32_t luaGetPartyDuelPartners(lua_State* L);
		static int32_t luaCanDoCombat(lua_State* L);
		static int32_t luaSetMonsterUniqueTarget(lua_State* L);
		static int32_t luaGetPlayerBattleing(lua_State* L);
		static int32_t luaSetPlayerBattleing(lua_State* L);
		static int32_t luaDoCreatureCastSpell(lua_State* L);
		static int32_t luaDoCreatureChangeHealth(lua_State* L);
		static int32_t luaDoPvpArenaJoin(lua_State* L);
		static int32_t luaDoPvpArenaLeave(lua_State* L);
		static int32_t luaDoPvpArenaCreate(lua_State* L);
		static int32_t luaGetPlayerPvpArena(lua_State* L);
		static int32_t luaGetPvpArenaUsersCount(lua_State* L);
		static int32_t luaGetPvpArenaUsers(lua_State* L);
		static int32_t luaGetPlayerPvpArenaTeam(lua_State* L);
		static int32_t luaDoNpcSetOpponent(lua_State* L);
		...
		static int32_t luaGetTournamentInfo(lua_State* L);
		static int32_t luaDoTournamentJoin(lua_State* L);
		static int32_t luaDoTournamentLeave(lua_State* L);
		static int32_t luaGetTournamentLastId(lua_State* L);
		static int32_t luaGetPlayerTournamentInscribed(lua_State* L);
		static int32_t luaGetPlayerTournamentId(lua_State* L);
		static int32_t luaGetPlayerActiveTournamentId(lua_State* L);
		static int32_t luaGetPlayerTournamentReady(lua_State* L);
		static int32_t luaSetPlayerTournamentReady(lua_State* L);
		static int32_t luaGetPlayerAutoLoot(lua_State* L);
		static int32_t luaSetPlayerAutoLoot(lua_State* L);
		static int32_t luaGetCreatureByNickname(lua_State* L);
		static int32_t luaGetMonsterSpecialAbility(lua_State* L);
		static int32_t luaSetMonsterSpecialAbility(lua_State* L);
		static int32_t luaDoPlayerSendTmWindow(lua_State* L);
		static int32_t luaGetItemClientId(lua_State* L);
		static int32_t luaGetItemServerId(lua_State* L);
		static int32_t luaGetItemCount(lua_State* L);
		static int32_t luaGetItemUniqueOwner(lua_State* L);
		static int32_t luaDoDatalogCaught(lua_State* L);
		static int32_t luaDoSwapItems(lua_State* L);
		static int32_t luaDoPlayerSendPokemonStatusAdd(lua_State* L);
		static int32_t luaDoPlayerSendPokemonStatusRemove(lua_State* L);
		static int32_t luaDoPlayerSendPokemonStatusClear(lua_State* L);
		static int32_t luaDoDatalogBossSpawn(lua_State* L);
		static int32_t luaGetPlayerSurviveArena(lua_State* L);
		static int32_t luaSetPlayerSurviveArena(lua_State* L);
		static int32_t luaDoPlayerSendCustomQuestInfo(lua_State* L);
		static int32_t luaDoPlayerAddStatistic(lua_State* L);
		static int32_t luaDoDatalogPokeNickChange(lua_State* L);
		static int32_t luaGetItemAttributesBlob(lua_State* L);
		static int32_t luaDoItemLoadAttributes(lua_State* L);
		static int32_t luaDoDatalogEggGenerate(lua_State* L);
		static int32_t luaDoItemEraseUniqueOwner(lua_State* L);
		static int32_t luaIsNpc(lua_State* L);
		static int32_t luaDoDatalogPokemonLevelUp(lua_State* L);
		static int32_t luaSetPlayerDisconnectAtExit(lua_State* L);
		static int32_t luaDoCreateGuild(lua_State* L);
		static int32_t luaSetNpcHouser(lua_State* L);
		static int32_t luaDoMoveItem(lua_State* L);
		static int32_t luaGetHouseByGuildId(lua_State* L);
		static int32_t luaGetItemSellPrice(lua_State* L);
		static int32_t luaSetTVChannelPassword(lua_State* L);
		static int32_t luaDoPlayerAddBalanceByName(lua_State* L);
		static int32_t luaDoPlayerAddDepotItemByName(lua_State* L);
		static int32_t luaDoPlayerAddDepotItemByNameWithDepotid(lua_State* L);
		static int32_t luaGetCreatureDamageRatioByMaster(lua_State* L);
        static int32_t luaDoGuildCreateRank(lua_State* L);
        static int32_t luaSetCreatureBaseSpeed(lua_State* L);
        static int32_t luaDoPlayerOpenChannel(lua_State* L);
        static int32_t luaGetGuildRankIdByName(lua_State* L);
        static int32_t luaGetPlayerUsingOtClient(lua_State* L);
        static int32_t luaDoSendPlayerExtendedOpcode(lua_State* L);
        static int32_t luaDoPlayerSendPokedexInfo(lua_State* L);
        static int32_t luaSetCreatureIcon(lua_State* L);
        static int32_t luaGetCreatureIcon(lua_State* L);
        static int32_t luaDoSendCreatureJump(lua_State* L);
        static int32_t luaDoCreatureGiveKillersExperience(lua_State* L);        
        static int32_t luaSetCreatureSkillLoss(lua_State* L);
        static int32_t luaSetMonsterExperienceRate(lua_State* L);
        static int32_t luaDoUpdateMonsterLoot(lua_State* L);
        static int32_t luaDoPlayerSendCustomOutfitWindow(lua_State* L);
        static int32_t luaSetMonsterVarPokeStat(lua_State* L);
        static int32_t luaGetMonsterVarPokeStat(lua_State* L);
        static int32_t luaDoSendCreatureEffect(lua_State* L);
        static int32_t luaDoSendPlayerDollCaseStatus(lua_State* L);
        static int32_t luaDoSendPlayerDollCaseUpdate(lua_State* L);
        static int32_t luaDoSendPlayerSlotMachine(lua_State* L);   
        static int32_t luaDoSendPlayerMarketEnter(lua_State* L);     
        static int32_t luaDoCreatureDie(lua_State* L);
        static int32_t luaDoSendPlayerTip(lua_State* L);
        static int32_t luaDoSendPlayerPokemonLevelUp(lua_State* L);		
        ...
        static int32_t luaGetPlayerDepotTopItemById(lua_State* L);
        static int32_t luaGetPlayerIsAfk(lua_State* L);
        static int32_t luaSetPlayerIsAfk(lua_State* L);
        static int32_t luaDoUpdateQuestMission(lua_State* L);
