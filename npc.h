...
class Npc : public Creature
{
	public:
		...
		void setOpponent(Player* _opponent) {opponent = _opponent;}
	...
	protected:
		...
		virtual std::string getDescription(int32_t lookDistance, Player* player = NULL) const {return nameDescription + ".";}
