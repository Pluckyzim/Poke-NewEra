...
class Map
{
	public:
	    ...
	    static const int32_t maxViewportX = 25; //min value: maxClientViewportX + 1
		static const int32_t maxViewportY = 13; //min value: maxClientViewportY + 1
		static const int32_t maxClientViewportX = 24;
		...
		*/
		...
		bool checkSightLineDirect(const Position& fromPos, const Position& toPos, bool floorCheck) const;
		...
		*/
		...
		bool getPathMatching(const Creature* creature, std::list<Direction>& dirList,
			const FrozenPathingConditionCall& pathCondition, const FindPathParams& fpp, bool extendedNodes = false);
