...
enum ConditionType_t
{
	...
	CONDITION_SLEEP = 1 << 24, // PS
	//CONDITION_LOWACCURACY = 1 << 25, // PS
	//CONDITION_INSOMNIA = 1 << 26, // PS
	//CONDITION_REFLECT = 1 << 27, // PS
	//CONDITION_PREVENTSTATUS = 1 << 28, // PS
	CONDITION_EXTRASPATK = 1 << 25, // PS
	CONDITION_EXTRASPDEF = 1 << 26, // PS
	CONDITION_INVULNERABLE = 1 << 27, // PS
	CONDITION_CUSTOM = 1 << 28,
	//CONDITION_INVULNERABLE = 1UL << 31, // PS
};
...
class ConditionSleep : public ConditionGeneric // PS
{
	public:
		ConditionSleep(ConditionId_t _id, ConditionType_t _type, int32_t _ticks, bool _buff, uint32_t _subId);
		virtual ~ConditionSleep() {}

		virtual void addCondition(Creature* creature, const Condition* addCondition);
		virtual bool executeCondition(Creature* creature, int32_t interval);

		virtual ConditionSleep* clone() const {return new ConditionSleep(*this);}
	...
	protected:
		uint32_t internalSleepTicks, sleepTicks;
};

class ConditionCustom: public Condition
{
	public:
		ConditionCustom(ConditionId_t _id, ConditionType_t _type, int32_t _ticks, bool _buff, uint32_t _subId, uint16_t _effect);
		virtual ~ConditionCustom() {}

		virtual bool executeCondition(Creature* creature, int32_t interval);
		virtual void addCondition(Creature* creature, const Condition* addCondition);

		virtual ConditionCustom* clone() const {return new ConditionCustom(*this);}
...
class ConditionExtraSpAtk: public Condition
{
	public:
		ConditionExtraSpAtk(ConditionId_t _id, ConditionType_t _type, int32_t _ticks, bool _buff, uint32_t _subId, int32_t extraSpAtkAmount);
		virtual ~ConditionExtraSpAtk() {}
		...
		virtual ConditionExtraSpAtk* clone() const {return new ConditionExtraSpAtk(*this);}
...
class ConditionExtraSpDef: public Condition
{
	public:
		ConditionExtraSpDef(ConditionId_t _id, ConditionType_t _type, int32_t _ticks, bool _buff, uint32_t _subId, int32_t extraSpDefAmount);
		virtual ~ConditionExtraSpDef() {}
		...
		virtual ConditionExtraSpDef* clone() const {return new ConditionExtraSpDef(*this);}
...
class ConditionInvulnerable : public ConditionGeneric // PS
{
	public:
		ConditionInvulnerable(ConditionId_t _id, ConditionType_t _type, int32_t _ticks, bool _buff, uint32_t _subId);
		virtual ~ConditionInvulnerable() {}

		virtual void addCondition(Creature* creature, const Condition* addCondition);
		virtual bool executeCondition(Creature* creature, int32_t interval);

		virtual ConditionInvulnerable* clone() const {return new ConditionInvulnerable(*this);}
...
class ConditionDrunk : public ConditionGeneric // PS
{
	public:
		ConditionDrunk(ConditionId_t _id, ConditionType_t _type, int32_t _ticks, bool _buff, uint32_t _subId);
		virtual ~ConditionDrunk() {}

		virtual void addCondition(Creature* creature, const Condition* addCondition);
		virtual bool executeCondition(Creature* creature, int32_t interval);

		virtual ConditionDrunk* clone() const {return new ConditionDrunk(*this);}
