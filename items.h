...
class ItemType
{
	...
	public:
		...
		bool stopTime, showCount, clientCharges, stackable, showDuration, showCharges, showAttributes,
			...
			floorChange[CHANGE_LAST], forceTransferToDepot, rareEffect, blockItemDropOver;
		...
		uint16_t transformUseTo[2], transformToFree, transformEquipTo, transformDeEquipTo,
			id, clientId, maxItems, slotPosition, wieldPosition, speed, maxTextLen, writeOnceItemId, wareId;
