...
ScriptEnviroment::TempStorageMap ScriptEnviroment::m_tempStorageMap;
...
bool ScriptEnviroment::getTempStorage(const std::string key, std::string& value)
{
	TempStorageMap::const_iterator it = m_tempStorageMap.find(key);
	if(it != m_tempStorageMap.end())
	{
		value = it->second;
		return true;
	}
...
std::string LuaScriptInterface::getError(ErrorCode_t code)
{
	switch(code)
	{
		...
		case LUA_ERROR_CHANNEL_NOT_FOUND:
            return "Channel not found";
        case LUA_ERROR_TOURNAMENT_NOT_FOUND:
...
void LuaScriptInterface::registerFunctions()
{
	...
	//getPlayerItemByIdWithAttribute(cid, deepSearch, itemId, attribute_key, attribute_value[, subType = -1])
	lua_register(m_luaState, "getPlayerItemByIdWithAttribute", LuaScriptInterface::luaGetPlayerItemByIdWithAttribute);
	
	//getPlayerItemByAttribute(cid, deepSearch, attribute_key, attribute_value)
	lua_register(m_luaState, "getPlayerItemByAttribute", LuaScriptInterface::luaGetPlayerItemByAttribute);
	...
	//getStorage(key)
	lua_register(m_luaState, "getTempStorage", LuaScriptInterface::luaGetTempStorage);

	//doSetStorage(key, value)
	lua_register(m_luaState, "setTempStorage", LuaScriptInterface::luaSetTempStorage);
	...
	//getThingFromPos(pos[, displayError = false])
	...
	//doPlayerSendPokemonSkills(cid, iconItemId, skills)
	lua_register(m_luaState, "doPlayerSendPokemonSkills", LuaScriptInterface::luaDoPlayerSendPokemonSkills);
	
	//doPlayerSendPokemonSkillContainerClose(cid)
	lua_register(m_luaState, "doPlayerSendPokemonSkillContainerClose", LuaScriptInterface::luaDoPlayerSendPokemonSkillContainerClose);
	
	//doPlayerSendPokemonSkillContainerOpen(cid)
	lua_register(m_luaState, "doPlayerSendPokemonSkillContainerOpen", LuaScriptInterface::luaDoPlayerSendPokemonSkillContainerOpen);
	
	//doPlayerSendPokemonWindowAddPokemonIcon(cid, itemId, fastcallNumber, textColor, text)
	lua_register(m_luaState, "doPlayerSendPokemonWindowAddPokemonIcon", LuaScriptInterface::luaDoPlayerSendPokemonWindowAddPokemonIcon);
	
	//doPlayerSendPokemonWindowRemovePokemonIcon(cid, fastcallNumber)
	lua_register(m_luaState, "doPlayerSendPokemonWindowRemovePokemonIcon", LuaScriptInterface::luaDoPlayerSendPokemonWindowRemovePokemonIcon);
	
	//doPlayerSendPokemonWindowUpdatePokemonIcon(cid, fastcallNumber, textColor, text)
	lua_register(m_luaState, "doPlayerSendPokemonWindowUpdatePokemonIcon", LuaScriptInterface::luaDoPlayerSendPokemonWindowUpdatePokemonIcon);
	
	//doPlayerSendPokemonWindowOpen(cid)
	lua_register(m_luaState, "doPlayerSendPokemonWindowOpen", LuaScriptInterface::luaDoPlayerSendPokemonWindowOpen);
	
	//doPlayerSendPokemonWindowClose(cid)
	lua_register(m_luaState, "doPlayerSendPokemonWindowClose", LuaScriptInterface::luaDoPlayerSendPokemonWindowClose);
	
	//doPlayerSendPokemonSkillCooldown(cid, itemId, cooldown)
	lua_register(m_luaState, "doPlayerSendPokemonSkillCooldown", LuaScriptInterface::luaDoPlayerSendPokemonSkillCooldown);
	
	//doPlayerSendPoekdexStatus(cid, status)
	lua_register(m_luaState, "doPlayerSendPokedexStatus", LuaScriptInterface::luaDoPlayerSendPokedexStatus);
	
	//doPlayerSendPokedexOpen(cid)
	lua_register(m_luaState, "doPlayerSendPokedexOpen", LuaScriptInterface::luaDoPlayerSendPokedexOpen);
	
	//doPlayerSendPokedexItemUpdate(cid, pokemonNumber, status)
	lua_register(m_luaState, "doPlayerSendPokedexItemUpdate", LuaScriptInterface::luaDoPlayerSendPokedexItemUpdate);
	...
	//getSearchString(fromPosition, toPosition, player[, fromIsCreature = false[, toIsCreature = false]])
	...
	//setPlayerMagicLevel(cid, newMagicLevel)
	lua_register(m_luaState, "setPlayerMagicLevel", LuaScriptInterface::luaSetPlayerMagicLevel);
	
	//setPlayerMagicLevelPercent(cid, newMagicLevelPercent)
	lua_register(m_luaState, "setPlayerMagicLevelPercent", LuaScriptInterface::luaSetPlayerMagicLevelPercent);
	...
	//doPlayerAddDepotItem(cid, depotid, itemuid)
	lua_register(m_luaState, "doPlayerAddDepotItem", LuaScriptInterface::luaDoPlayerAddDepotItem);
	
	//doPlayerWriteItem(cid, uid)
	lua_register(m_luaState, "doPlayerWriteItem", LuaScriptInterface::luaDoPlayerWriteItem);
	
	//doPlayerWriteItem(cid, uid)
	lua_register(m_luaState, "doPlayerOpenContainer", LuaScriptInterface::luaDoPlayerOpenContainer);
    ...
    /*//doCreateTile(itemid, pos)
	//Create a tile in a pos
	lua_register(m_luaState, "doCreateTile", LuaScriptInterface::luaDoCreateTile);*/
	...
	//doSummonMonster(cid, name[, forced])
	...
	//getMonsterSex(cid) PS
	lua_register(m_luaState, "getMonsterSex", LuaScriptInterface::luaGetMonsterSex);
	
	//setMonsterSex(cid, newSex) PS
	lua_register(m_luaState, "setMonsterSex", LuaScriptInterface::luaSetMonsterSex);
	
	//getMonsterLevel(cid) PS
	lua_register(m_luaState, "getMonsterLevel", LuaScriptInterface::luaGetMonsterLevel);
	
	//setMonsterLevel(cid, newLevel) PS
	lua_register(m_luaState, "setMonsterLevel", LuaScriptInterface::luaSetMonsterLevel);
	
	//setMonsterExtraPoints(cid, newExtraPoints) PS
	lua_register(m_luaState, "setMonsterExtraPoints", LuaScriptInterface::luaSetMonsterExtraPoints);
	
	//getMonsterExtraPoints(cid) PS
	lua_register(m_luaState, "getMonsterExtraPoints", LuaScriptInterface::luaGetMonsterExtraPoints);
	
	//getMonsterExtraSpAtk PS
	lua_register(m_luaState, "getMonsterExtraSpAtk", LuaScriptInterface::luaGetMonsterExtraSpAtk);
	
	//doMonsterAddExtraSpAtk(cid, amount) PS
	lua_register(m_luaState, "doMonsterAddExtraSpAtk", LuaScriptInterface::luaDoMonsterAddExtraSpAtk);
	
	//getMonsterExtraSpDef PS
	lua_register(m_luaState, "getMonsterExtraSpDef", LuaScriptInterface::luaGetMonsterExtraSpDef);
	
	//doMonsterAddExtraSpDef PS
	lua_register(m_luaState, "doMonsterAddExtraSpDef", LuaScriptInterface::luaDoMonsterAddExtraSpDef);
	...
	lua_register(m_luaState, "doCreatureSetTarget", LuaScriptInterface::luaDoCreatureSetTarget);
	...
	//doRemoveCreature(cid[, forceLogout = true, showError = true])
	...
	//getContainerItemByIndex(container_index, slot_index)
	lua_register(m_luaState, "getContainerItemByIndex", LuaScriptInterface::luaGetContainerItemByIndex);
	...
	//getWorldLightState()
	lua_register(m_luaState, "getWorldLightState", LuaScriptInterface::luaGetWorldLightState);
	...
	//createConditionObject(type[, ticks[, buff[, subId[, conditionIdDefault = false]]]])
	...
	//setItemUniqueOwner(item, uniqueOwner)
	lua_register(m_luaState, "setItemUniqueOwner", LuaScriptInterface::luaSetItemUniqueOwner);

	//doSetCreatureOutfit(cid, outfit, time[, subId = 0])
	...
	//getCreatureNickname(cid)
	lua_register(m_luaState, "getCreatureNickname", LuaScriptInterface::luaGetCreatureNickname);
	
	//setCreatureNickname(cid, nickname)
	lua_register(m_luaState, "setCreatureNickname", LuaScriptInterface::luaSetCreatureNickname);
	...
	//doMovePlayerItem(cid, itemuid, toPosition[, indexWhereever = false])
	lua_register(m_luaState, "doMovePlayerItem", LuaScriptInterface::luaDoMovePlayerItem);
	
	//doPlayerUseItem(cid, itemuid)
	lua_register(m_luaState, "doPlayerUseItem", LuaScriptInterface::luaDoPlayerUseItem);
	...
	//doItemSetCount(uid, value)
	lua_register(m_luaState, "doItemSetCount", LuaScriptInterface::luaDoItemSetCount);

	//doItemEraseAttribute(uid, key)
	lua_register(m_luaState, "doItemEraseAttribute", LuaScriptInterface::luaDoItemEraseAttribute);
	
	//doItemSetSpecialDescription(uid, desc)
	lua_register(m_luaState, "doItemSetSpecialDescription", LuaScriptInterface::luaDoItemSetSpecialDescription);
	...
	//getPlayerAutoTrade(cid)
	lua_register(m_luaState, "getPlayerAutoTrade", LuaScriptInterface::luaGetPlayerAutoTrade);
	
	//setPlayerAutoTrade(cid, autoTrade)
	lua_register(m_luaState, "setPlayerAutoTrade", LuaScriptInterface::luaSetPlayerAutoTrade);
	
	//doPlayerTalkOnChannel(cid, message, speakClass, channelId)
	lua_register(m_luaState, "doPlayerTalkOnChannel", LuaScriptInterface::luaDoPlayerTalkOnChannel);
	
	//doPlayerSendChannelsDialog(cid, channelsIds)
	lua_register(m_luaState, "doPlayerSendChannelsDialog", LuaScriptInterface::luaDoPlayerSendChannelsDialog);
	
	//doPlayerJoinChannel(cid, channelId)
	lua_register(m_luaState, "doPlayerJoinChannel", LuaScriptInterface::luaDoPlayerJoinChannel);
	
	//doPlayerLeaveChannel(cid, channelId)
	lua_register(m_luaState, "doPlayerLeaveChannel", LuaScriptInterface::luaDoPlayerLeaveChannel);
	
	//doPlayerSendTVChannelsDialog(cid)
	lua_register(m_luaState, "doPlayerSendTVChannelsDialog", LuaScriptInterface::luaDoPlayerSendTVChannelsDialog);
	
	//doPlayerCreateTVChannel(cid)
	lua_register(m_luaState, "doPlayerCreateTVChannel", LuaScriptInterface::luaDoPlayerCreateTVChannel);
	
	//doPlayerDeleteTVChannel(cid)
	lua_register(m_luaState, "doPlayerDeleteTVChannel", LuaScriptInterface::luaDoPlayerDeleteTVChannel);
	
	//getPlayerRecordingTV(cid)
	lua_register(m_luaState, "getPlayerRecordingTV", LuaScriptInterface::luaGetPlayerRecordingTV);
	
	//getPlayerWatchingTV(cid)
	lua_register(m_luaState, "getPlayerWatchingTV", LuaScriptInterface::luaGetPlayerWatchingTV);
	
	//getPlayerTVChannelId(cid)
	lua_register(m_luaState, "getPlayerTVChannelId", LuaScriptInterface::luaGetPlayerTVChannelId);
	
	//setTVChannelName(cid, newChannelName)
	lua_register(m_luaState, "setTVChannelName", LuaScriptInterface::luaSetTVChannelName);
	
	//getTVChannelViewers(cid)
	lua_register(m_luaState, "getTVChannelViewers", LuaScriptInterface::luaGetTVChannelViewers);
	
	//doPlayerLeaveTVChannel(tvChannelId, playerId)
	lua_register(m_luaState, "doPlayerLeaveTVChannel", LuaScriptInterface::luaDoPlayerLeaveTVChannel);
	
	//doTVChannelBan(tvChannelId, playerId)
	lua_register(m_luaState, "doTVChannelBan", LuaScriptInterface::luaDoTVChannelBan);
	
	//doTVChannelUnban(tvChannelId, playerId)
	lua_register(m_luaState, "doTVChannelUnban", LuaScriptInterface::luaDoTVChannelUnban);
	
	//getPlayerDueling(cid)
	lua_register(m_luaState, "getPlayerDueling", LuaScriptInterface::luaGetPlayerDueling);
	
	//getPlayerDuelPokemonRemaing(cid)
	lua_register(m_luaState, "getPlayerDuelPokemonRemaing", LuaScriptInterface::luaGetPlayerDuelPokemonRemaing);
	
	//setPlayerDuelPokemonRemaing(cid, _duelPokemonRemaing)
	lua_register(m_luaState, "setPlayerDuelPokemonRemaing", LuaScriptInterface::luaSetPlayerDuelPokemonRemaing);
	
	//getPlayerPartyDuel(cid)
	lua_register(m_luaState, "getPlayerPartyDuel", LuaScriptInterface::luaGetPlayerPartyDuel);
	
	//doPartyDuelLeave(cid)
	lua_register(m_luaState, "doPartyDuelLeave", LuaScriptInterface::luaDoPartyDuelLeave);
	
	//doPartyDuelInvite(leader, invited)
	lua_register(m_luaState, "doPartyDuelInvite", LuaScriptInterface::luaDoPartyDuelInvite);
	
	//doPartyDuelJoin(leader, invited)
	lua_register(m_luaState, "doPartyDuelJoin", LuaScriptInterface::luaDoPartyDuelJoin);
	
	//doPartyDuelCreate(leader, maxMembers, maxPokemon, bet)
	lua_register(m_luaState, "doPartyDuelCreate", LuaScriptInterface::luaDoPartyDuelCreate);
	
	//getPartyDuelPartners(player)
	lua_register(m_luaState, "getPartyDuelPartners", LuaScriptInterface::luaGetPartyDuelPartners);
	
	//canDoCombat(fromCid, toCid)
	lua_register(m_luaState, "canDoCombat", LuaScriptInterface::luaCanDoCombat);
	...
	//getPlayerBattleing(cid)
	lua_register(m_luaState, "getPlayerBattleing", LuaScriptInterface::luaGetPlayerBattleing);
	
	//setPlayerBattleing(cid, _battleing)
	lua_register(m_luaState, "setPlayerBattleing", LuaScriptInterface::luaSetPlayerBattleing);
	...
	lua_register(m_luaState, "doCreatureChangeHealth", LuaScriptInterface::luaDoCreatureChangeHealth);
	
	//doPvpArenaJoin(cid, arenaId, teamId)
	lua_register(m_luaState, "doPvpArenaJoin", LuaScriptInterface::luaDoPvpArenaJoin);
	
	//doPvpArenaLeave(cid)
	lua_register(m_luaState, "doPvpArenaLeave", LuaScriptInterface::luaDoPvpArenaLeave);
	
	//doPvpArenaCreate(arenaId, blueSpawnPosition, redSpawnPosition, exitPosition, maxLevel, blueChannel, redChannel)
	lua_register(m_luaState, "doPvpArenaCreate", LuaScriptInterface::luaDoPvpArenaCreate);
	
	//getPlayerPvpArena(cid)
	lua_register(m_luaState, "getPlayerPvpArena", LuaScriptInterface::luaGetPlayerPvpArena);
	
	//getPvpArenaUsersCount(arenaId)
	lua_register(m_luaState, "getPvpArenaUsersCount", LuaScriptInterface::luaGetPvpArenaUsersCount);
	
	//getPvpArenaUsers(arenaId)
	lua_register(m_luaState, "getPvpArenaUsers", LuaScriptInterface::luaGetPvpArenaUsers);
	
	//getPlayerPvpArenaTeam(cid)
	lua_register(m_luaState, "getPlayerPvpArenaTeam", LuaScriptInterface::luaGetPlayerPvpArenaTeam);
	
	//doNpcSetOpponent(npc, cid)
	lua_register(m_luaState, "doNpcSetOpponent", LuaScriptInterface::luaDoNpcSetOpponent);
	...
	lua_register(m_luaState, "getPlayerExtraLootRate", LuaScriptInterface::luaGetPlayerExtraLootRate);
	
	//setPlayerExtraLootRate(cid, value)
	lua_register(m_luaState, "setPlayerExtraLootRate", LuaScriptInterface::luaSetPlayerExtraLootRate);
	
	//getTournamentInfo(id)
	lua_register(m_luaState, "getTournamentInfo", LuaScriptInterface::luaGetTournamentInfo);
	
	//doTournamentJoin(cid, tournamentId)
	lua_register(m_luaState, "doTournamentJoin", LuaScriptInterface::luaDoTournamentJoin);
	
	//doTournamentLeave(cid, tournamentId)
	lua_register(m_luaState, "doTournamentLeave", LuaScriptInterface::luaDoTournamentLeave);
	
	//getTournamentLastId()
	lua_register(m_luaState, "getTournamentLastId", LuaScriptInterface::luaGetTournamentLastId);
	
	//getPlayerTournamentInscribed(cid)
	lua_register(m_luaState, "getPlayerTournamentInscribed", LuaScriptInterface::luaGetPlayerTournamentInscribed);
	
	//getPlayerTournamentId(cid)
	lua_register(m_luaState, "getPlayerTournamentId", LuaScriptInterface::luaGetPlayerTournamentId);
	
	//getPlayerActiveTournamentId(cid)
	lua_register(m_luaState, "getPlayerActiveTournamentId", LuaScriptInterface::luaGetPlayerActiveTournamentId);
	
	//getPlayerTournamentReady(cid)
	lua_register(m_luaState, "getPlayerTournamentReady", LuaScriptInterface::luaGetPlayerTournamentReady);
	
	//setPlayerTournamentReady(cid, ready)
	lua_register(m_luaState, "setPlayerTournamentReady", LuaScriptInterface::luaSetPlayerTournamentReady);
	
	//getPlayerAutoLoot(cid)
	lua_register(m_luaState, "getPlayerAutoLoot", LuaScriptInterface::luaGetPlayerAutoLoot);
	
	//setPlayerAutoLoot(cid, autoLoot)
	lua_register(m_luaState, "setPlayerAutoLoot", LuaScriptInterface::luaSetPlayerAutoLoot);
	
	//getCreatureByNickname(nickname)
	lua_register(m_luaState, "getCreatureByNickname", LuaScriptInterface::luaGetCreatureByNickname);
	
	//getMonsterSpecialAbility(cid)
	lua_register(m_luaState, "getMonsterSpecialAbility", LuaScriptInterface::luaGetMonsterSpecialAbility);
	
	//setMonsterSpecialAbility(cid, ability)
	lua_register(m_luaState, "setMonsterSpecialAbility", LuaScriptInterface::luaSetMonsterSpecialAbility);
	
	//doPlayerSendTmWindow(cid, tmMove, moves)
	lua_register(m_luaState, "doPlayerSendTmWindow", LuaScriptInterface::luaDoPlayerSendTmWindow);
	
	//getItemClientId(itemid)
	lua_register(m_luaState, "getItemClientId", LuaScriptInterface::luaGetItemClientId);
	
	//getItemServerId(itemid)
	lua_register(m_luaState, "getItemServerId", LuaScriptInterface::luaGetItemServerId);
	
	//getItemCount(uid)
	lua_register(m_luaState, "getItemCount", LuaScriptInterface::luaGetItemCount);
	
	//getItemUniqueOwner(uid)
	lua_register(m_luaState, "getItemUniqueOwner", LuaScriptInterface::luaGetItemUniqueOwner);
	
	//doDatalogCaught(cid, pokemonNumber, tries)
	lua_register(m_luaState, "doDatalogCaught", LuaScriptInterface::luaDoDatalogCaught);
	
	//doSwapItems(itemA, itemB)
	lua_register(m_luaState, "doSwapItems", LuaScriptInterface::luaDoSwapItems);
	...
	//doDatalogBossSpawn(worldId, name, pos, date)
	lua_register(m_luaState, "doDatalogBossSpawn", LuaScriptInterface::luaDoDatalogBossSpawn);
	
	//getPlayerSurviveArena(cid)
	lua_register(m_luaState, "getPlayerSurviveArena", LuaScriptInterface::luaGetPlayerSurviveArena);
	
	//setPlayerSurviveArena(cid, value)
	lua_register(m_luaState, "setPlayerSurviveArena", LuaScriptInterface::luaSetPlayerSurviveArena);
	
	//doPlayerSendCustomQuestInfo(cid, questId, missions)
	lua_register(m_luaState, "doPlayerSendCustomQuestInfo", LuaScriptInterface::luaDoPlayerSendCustomQuestInfo);
	
	//doPlayerAddStatistic(cid, statisticId, value)
	lua_register(m_luaState, "doPlayerAddStatistic", LuaScriptInterface::luaDoPlayerAddStatistic);
	
	//doDatalogPokeNickChange(cid, oldNickname, newNickname, date)
	lua_register(m_luaState, "doDatalogPokeNickChange", LuaScriptInterface::luaDoDatalogPokeNickChange);
	
	//getItemAttributesBlob(uid)
	lua_register(m_luaState, "getItemAttributesBlob", LuaScriptInterface::luaGetItemAttributesBlob);
	
	//doItemLoadAttributes(uid, resultColumn, resultId)
	lua_register(m_luaState, "doItemLoadAttributes", LuaScriptInterface::luaDoItemLoadAttributes);
	
	//doDatalogEggGenerate(cid, egg, date, tries)
	lua_register(m_luaState, "doDatalogEggGenerate", LuaScriptInterface::luaDoDatalogEggGenerate);
	
	//doItemEraseUniqueOwner(uid)
	lua_register(m_luaState, "doItemEraseUniqueOwner", LuaScriptInterface::luaDoItemEraseUniqueOwner);
	
	//isNpc(cid)
	lua_register(m_luaState, "isNpc", LuaScriptInterface::luaIsNpc);
	
	//doDatalogPokemonLevelUp(cid, pokemonNumber, fromLevel, toLevel, date, position)
	lua_register(m_luaState, "doDatalogPokemonLevelUp", LuaScriptInterface::luaDoDatalogPokemonLevelUp);
	
	//setPlayerDisconnectAtExit(cid, disconnectAtExit)
	lua_register(m_luaState, "setPlayerDisconnectAtExit", LuaScriptInterface::luaSetPlayerDisconnectAtExit);
	
	//doCreateGuild(cid, guildName)
	lua_register(m_luaState, "doCreateGuild", LuaScriptInterface::luaDoCreateGuild);
	
	//setNpcHouser(cid, houser)
	lua_register(m_luaState, "setNpcHouser", LuaScriptInterface::luaSetNpcHouser);
	
	//doMoveItem(item, pos)
	lua_register(m_luaState, "doMoveItem", LuaScriptInterface::luaDoMoveItem);
	
	//getHouseByGuildId(guildId)
	lua_register(m_luaState, "getHouseByGuildId", LuaScriptInterface::luaGetHouseByGuildId);
	
	//getItemSellPrice(itemId)
	lua_register(m_luaState, "getItemSellPrice", LuaScriptInterface::luaGetItemSellPrice);
	
	//setTVChannelPassword(cid, password)
	lua_register(m_luaState, "setTVChannelPassword", LuaScriptInterface::luaSetTVChannelPassword);
	
	//doPlayerAddBalanceByName(name, value)
	lua_register(m_luaState, "doPlayerAddBalanceByName", LuaScriptInterface::luaDoPlayerAddBalanceByName);

    //doPlayerAddDepotItemByName(name, itemuid)
	lua_register(m_luaState, "doPlayerAddDepotItemByName", LuaScriptInterface::luaDoPlayerAddDepotItemByName);
	
    //doPlayerAddDepotItemByNameWithDepotid(name, depot, itemuid)
	lua_register(m_luaState, "doPlayerAddDepotItemByNameWithDepotid", LuaScriptInterface::luaDoPlayerAddDepotItemByNameWithDepotid);
	
	//getCreatureDamageRatioByMaster(cid, master)
	lua_register(m_luaState, "getCreatureDamageRatioByMaster", LuaScriptInterface::luaGetCreatureDamageRatioByMaster);
	
	//doGuildCreateRank(guild, name)
	lua_register(m_luaState, "doGuildCreateRank", LuaScriptInterface::luaDoGuildCreateRank);
	
	//setCreatureBaseSpeed(cid, baseSpeed)
	lua_register(m_luaState, "setCreatureBaseSpeed", LuaScriptInterface::luaSetCreatureBaseSpeed);
	
	//doPlayerOpenChannel(cid, channelId)
	lua_register(m_luaState, "doPlayerOpenChannel", LuaScriptInterface::luaDoPlayerOpenChannel);
	
	//getGuildRankIdByName(guildId, rankName)
	lua_register(m_luaState, "getGuildRankIdByName", LuaScriptInterface::luaGetGuildRankIdByName);
	
	//getPlayerUsingOtClient(cid)
	lua_register(m_luaState, "getPlayerUsingOtClient", LuaScriptInterface::luaGetPlayerUsingOtClient);
	...
	//doPlayerSendPokedexInfo(cid, pokemonId, details, moves, effectiveness, families)
	lua_register(m_luaState, "doPlayerSendPokedexInfo", LuaScriptInterface::luaDoPlayerSendPokedexInfo);
	...
	//doCreatureGiveKillersExperience(cid)
	lua_register(m_luaState, "doCreatureGiveKillersExperience", LuaScriptInterface::luaDoCreatureGiveKillersExperience);
	
	//setCreatureSkillLoss(cid, skillLoss)
	lua_register(m_luaState, "setCreatureSkillLoss", LuaScriptInterface::luaSetCreatureSkillLoss);
	
	//setMonsterExperienceRate(cid, experienceRate)
	lua_register(m_luaState, "setMonsterExperienceRate", LuaScriptInterface::luaSetMonsterExperienceRate);
	
	//doUpdateMonsterLoot(name, loot)
	lua_register(m_luaState, "doUpdateMonsterLoot", LuaScriptInterface::luaDoUpdateMonsterLoot);
	
	//doPlayerSendCustomOutfitWindow(cid, outfits)
	lua_register(m_luaState, "doPlayerSendCustomOutfitWindow", LuaScriptInterface::luaDoPlayerSendCustomOutfitWindow);
	
	//setMonsterVarPokeStat(cid, pokeStat, modifier)
	lua_register(m_luaState, "setMonsterVarPokeStat", LuaScriptInterface::luaSetMonsterVarPokeStat);
	
	//getMonsterVarPokeStat(cid, pokeStat)
	lua_register(m_luaState, "getMonsterVarPokeStat", LuaScriptInterface::luaGetMonsterVarPokeStat);
	
	//doPlayerSendDollCaseStatus(cid, status)
	lua_register(m_luaState, "doPlayerSendDollCaseStatus", LuaScriptInterface::luaDoSendPlayerDollCaseStatus);
	
	//doPlayerSendDollCaseUpdate(cid, pokemonNumber, status)
	lua_register(m_luaState, "doPlayerSendDollCaseUpdate", LuaScriptInterface::luaDoSendPlayerDollCaseUpdate);
	
	//doPlayerSendSlotMachine(cid, result1, result2, result3)
	lua_register(m_luaState, "doPlayerSendSlotMachine", LuaScriptInterface::luaDoSendPlayerSlotMachine);
	
	//doPlayerSendMarketEnter(cid)
	lua_register(m_luaState, "doPlayerSendMarketEnter", LuaScriptInterface::luaDoSendPlayerMarketEnter);
	
	//doCreatureDie(cid)
	lua_register(m_luaState, "doCreatureDie", LuaScriptInterface::luaDoCreatureDie);
	
	//doPlayerSendTip(cid, id)
	lua_register(m_luaState, "doPlayerSendTip", LuaScriptInterface::luaDoSendPlayerTip);
	
	//doPlayerSendPokemonLevelUp(pokemonNumber, newLevel, newMoves)
	lua_register(m_luaState, "doPlayerSendPokemonLevelUp", LuaScriptInterface::luaDoSendPlayerPokemonLevelUp);
	...
	//__L(str)
	lua_register(m_luaState, "__L", LuaScriptInterface::luaDoLocalization);
	
	//getPlayerLanguage(cid, language)
	lua_register(m_luaState, "setPlayerLanguage", LuaScriptInterface::luaSetPlayerLanguage);
	
	//getPlayerLanguage(cid)
	lua_register(m_luaState, "getPlayerLanguage", LuaScriptInterface::luaGetPlayerLanguage);
	
	//getPlayerDepotTopItemById(cid, depotId, itemId)
	lua_register(m_luaState, "getPlayerDepotTopItemById", LuaScriptInterface::luaGetPlayerDepotTopItemById);
	
	//getPlayerIsAfk(cid)
	lua_register(m_luaState, "getPlayerIsAfk", LuaScriptInterface::luaGetPlayerIsAfk);
	
	//setPlayerIsAfk(cid, value)
	lua_register(m_luaState, "setPlayerIsAfk", LuaScriptInterface::luaSetPlayerIsAfk);
	
	//doUpdateQuestMission(storageid, npcName, npcOutfit, npcPosition, missionLevel)
	lua_register(m_luaState, "doUpdateQuestMission", LuaScriptInterface::luaDoUpdateQuestMission);
...
int32_t LuaScriptInterface::luaGetInstantSpellInfo(lua_State* L)
{
	...
	setField(L, "needdirection", spell->getNeedDirection());
	setField(L, "castertargetordirection", spell->getCasterTargetOrDirection());
	/*setField(L, "name", spell->getName());
	setField(L, "words", spell->getWords());
	setField(L, "level", spell->getLevel());
	setField(L, "mlevel", spell->getMagicLevel());
...
int32_t LuaScriptInterface::luaDoPlayerSendPokemonSkills(lua_State* L) // PS
{
	//doPlayerSendPokemonSkills(cid, iconItemId, skills)
	...
	while(lua_next(L, -2))
	{
        skills.push_back((uint16_t)lua_tonumber(L, -1));
		lua_pop(L, 1);
	}
	lua_pop(L, 1);
    
    uint16_t iconItemId = popNumber(L);
    	
	ScriptEnviroment* env = getEnv();
	if(Player* player = env->getPlayerByUID(popNumber(L)))
	{
		player->sendPokemonSkills(iconItemId, skills);
		lua_pushboolean(L, true);
	}
	else
	{
...
int32_t LuaScriptInterface::luaDoPlayerSendPokemonSkillContainerClose(lua_State* L) // PS
{
	//doPlayerSendPokemonSkillContainerClose(cid)   	
	ScriptEnviroment* env = getEnv();
	if(Player* player = env->getPlayerByUID(popNumber(L)))
	{
		player->sendPokemonSkillContainerClose();
		lua_pushboolean(L, true);
	}
	else
	{
...
int32_t LuaScriptInterface::luaDoPlayerSendPokemonSkillContainerOpen(lua_State* L) // PS
{
	//doPlayerSendPokemonSkillContainerOpen(cid)   	
	ScriptEnviroment* env = getEnv();
	if(Player* player = env->getPlayerByUID(popNumber(L)))
	{
		player->sendPokemonSkillContainerOpen();
		lua_pushboolean(L, true);
	}
	else
	{
...
int32_t LuaScriptInterface::luaDoPlayerSendPokemonWindowAddPokemonIcon(lua_State* L) // PS
{
	//doPlayerSendPokemonWindowAddPokemonIcon(cid, itemId, fastcallNumber, textColor, text)
	if(lua_gettop(L) < 5)
	{
		errorEx("doPlayerSendPokemonWindowAddPokemonIcon -> Less than 5 parameters!");
		lua_pushboolean(L, false);
		return 1;
    }
    
    std::string text = popString(L);
    uint8_t textColor = popNumber(L);
    uint16_t fastcallNumber = popNumber(L);
    uint16_t itemId = popNumber(L);
    	
	ScriptEnviroment* env = getEnv();
	if(Player* player = env->getPlayerByUID(popNumber(L)))
	{
		player->sendPokemonWindowAddPokemonIcon(itemId, fastcallNumber, textColor, text);
		lua_pushboolean(L, true);
	}
	else
	{
...
int32_t LuaScriptInterface::luaDoPlayerSendPokemonWindowRemovePokemonIcon(lua_State* L) // PS
{
	//doPlayerSendPokemonWindowRemovePokemonIcon(cid, fastcallNumber)
	if(lua_gettop(L) < 2)
	{
		errorEx("doPlayerSendPokemonWindowRemovePokemonIcon -> Less than 2 parameters!");
		lua_pushboolean(L, false);
		return 1;
    }
	...
	if(Player* player = env->getPlayerByUID(popNumber(L)))
	{
		player->sendPokemonWindowRemovePokemonIcon(fastcallNumber);
		lua_pushboolean(L, true);
	}
	else
	{
...
int32_t LuaScriptInterface::luaDoPlayerSendPokemonWindowUpdatePokemonIcon(lua_State* L) // PS
{
	//doPlayerSendPokemonWindowAddPokemonIcon(cid, fastcallNumber, textColor, text)
	if(lua_gettop(L) < 4)
	{
		errorEx("doPlayerSendPokemonWindowUpdatePokemonIcon -> Less than 4 parameters!");
		lua_pushboolean(L, false);
		return 1;
    }
	...
	if(Player* player = env->getPlayerByUID(popNumber(L)))
	{
		player->sendPokemonWindowUpdatePokemonIcon(fastcallNumber, textColor, text);
		lua_pushboolean(L, true);
	}
	else
	{
...
int32_t LuaScriptInterface::luaDoPlayerSendPokemonWindowOpen(lua_State* L) // PS
{
	//doPlayerSendPokemonWindowOpen(cid)    	
	ScriptEnviroment* env = getEnv();
	if(Player* player = env->getPlayerByUID(popNumber(L)))
	{
		player->sendPokemonWindowOpen();
		lua_pushboolean(L, true);
	}
	else
	{
...
int32_t LuaScriptInterface::luaDoPlayerSendPokemonWindowClose(lua_State* L) // PS
{
	//doPlayerSendPokemonWindowClose(cid)    	
	ScriptEnviroment* env = getEnv();
	if(Player* player = env->getPlayerByUID(popNumber(L)))
	{
		player->sendPokemonWindowClose();
		lua_pushboolean(L, true);
	}
	else
	{
...
int32_t LuaScriptInterface::luaDoPlayerSendPokemonSkillCooldown(lua_State* L) // PS
{
	//doPlayerSendPokemonSkillCooldown(cid, itemId, cooldown)
	int32_t params = lua_gettop(L);
	if(params < 3)
	{
		errorEx("doPlayerSendPokemonSkillCooldown -> Less than 3 parameters!");
		lua_pushboolean(L, false);
		return 1;
    }
	...
	if(Player* player = env->getPlayerByUID(popNumber(L)))
	{
		player->sendPokemonSkillCooldown(itemId, cooldown);
		lua_pushboolean(L, true);
	}
	else
	{
...
int32_t LuaScriptInterface::luaDoPlayerSendPokedexStatus(lua_State* L) // PS
{
	//doPlayerSendPokedexStatus(cid, status)
	std::vector<uint8_t> status;
	
	lua_pushnil(L);
	while(lua_next(L, -2))
	{
        status.push_back((uint8_t)lua_tonumber(L, -1));
		lua_pop(L, 1);
	}
	lua_pop(L, 1);
	...
	if(Player* player = env->getPlayerByUID(popNumber(L)))
	{
		player->sendPokedexStatus(status);
		lua_pushboolean(L, true);
	}
	else
	{
...
int32_t LuaScriptInterface::luaDoPlayerSendPokedexOpen(lua_State* L) // PS
{
    //doPlayerSendPokedexOpen(cid)
    ScriptEnviroment* env = getEnv();
    if(Player* player = env->getPlayerByUID(popNumber(L)))
        player->sendPokedexOpen();
    else
        errorEx(getError(LUA_ERROR_PLAYER_NOT_FOUND));
    return 1;
}

int32_t LuaScriptInterface::luaDoPlayerSendPokedexItemUpdate(lua_State* L) // PS
{
    //doPlayerSendPokedexItemUpdate(cid, pokemonNumber, status)    
    uint8_t status = popNumber(L);
    uint16_t pokemonNumber = popNumber(L);
    
    ScriptEnviroment* env = getEnv();
    if(Player* player = env->getPlayerByUID(popNumber(L)))
        player->sendPokedexItemUpdate(pokemonNumber, status);
    else
        errorEx(getError(LUA_ERROR_PLAYER_NOT_FOUND));
    return 1;
}
...
int32_t LuaScriptInterface::luaGetSearchString(lua_State* L)
{
	...
	if(!toPos.x || !toPos.y || !fromPos.x || !fromPos.y)
	{
		...
		lua_pushstring(L, g_game.getSearchString(fromPos, toPos, player, fromIsCreature, toIsCreature).c_str());
...
int32_t LuaScriptInterface::luaDoPlayerAddDepotItem(lua_State* L)
{
	//doPlayerAddDepotItem(cid, depotid, itemuid[, intoChest = false])	
	bool intoChest = false;
	if (lua_gettop(L) > 3) {
		intoChest = popNumber(L);
    }
	
	uint32_t itemuid = (uint32_t)popNumber(L);
	...
	Item* item = env->getItemByUID(itemuid);
	if(!item)
	{
		errorEx(getError(LUA_ERROR_ITEM_NOT_FOUND));
		lua_pushboolean(L, false);
    ...
    Container* dest = depot->getContainer();
	if (intoChest) {
        Thing* tmpThing = NULL;
	    Item* tmpItem = NULL;
	    
        for (int32_t i = depot->__getLastIndex(); i >= depot->__getFirstIndex(); i -= 1) {
            if ((tmpThing = depot->__getThing(i)) && (tmpItem = tmpThing->getItem())) {
			    if (tmpItem->getID() == ITEM_DEPOT) {
                    dest = tmpItem->getContainer();
				    break;
                }
            }
	    }
    ...
    //uint32_t townId = player->getTown();
	//Depot* depot = player->getDepot(townId, true);
    //player->useDepot(depot->getDepotId(), true);
    //depot->setParent(player);
    lua_pushboolean(L, g_game.internalMoveItem(player, item->getParent(), dest, INDEX_WHEREEVER, item,
            item->getItemCount(), NULL, FLAG_NOLIMIT) == RET_NOERROR);
	return 1;
}

int32_t LuaScriptInterface::luaGetPlayerDepotTopItemById(lua_State* L)
{
	//getPlayerDepotTopItemById(cid, depotid, itemid)	
    ...
    lua_pushnumber(L, env->addThing(foundItem));
	return 1;
}

int32_t LuaScriptInterface::luaDoPlayerWriteItem(lua_State* L)
{
	//doPlayerWriteItem(cid, uid)
	uint32_t uid = (uint32_t)popNumber(L);
	ScriptEnviroment* env = getEnv();
...
int32_t LuaScriptInterface::luaDoPlayerOpenContainer(lua_State* L)
{
	//doPlayerOpenContainer(cid, uid)
	uint32_t uid = (uint32_t)popNumber(L);
	ScriptEnviroment* env = getEnv();
	...
	player->addContainer(15, container);
...
/*int32_t LuaScriptInterface::luaDoCreateTile(lua_State* L)
{
	//doCreateTile(itemid, pos)
	//Create a tile in a pos
	PositionEx pos;
...
{
	//getHouseFromPos(pos[, showError = false])
...
int32_t LuaScriptInterface::luaGetWorldLight(lua_State* L)
{
	...
	lua_pushnumber(L, g_game.getWorldLightState());
	lua_pushnumber(L, lightInfo.level);
	lua_pushnumber(L, lightInfo.color);
	return 1;
}

int32_t LuaScriptInterface::luaGetWorldLightState(lua_State* L)
{
	//getWorldLightState()
	lua_pushnumber(L, g_game.getWorldLightState());
	return 1;
...
int32_t LuaScriptInterface::luaGetPlayerItemByIdWithAttribute(lua_State* L)
{
    //getPlayerItemByIdWithAttribute(cid, deepSearch, itemId, attribute_key, attribute_value[, subType = -1])        
	ScriptEnviroment* env = getEnv();
    ...
    //boost::any attribute_value = popString(L);
    boost::any attribute_value;
	if(lua_isnumber(L, -1))
	{
		...
		if(std::floor(tmp) < tmp)
			...
			attribute_value = (int32_t)tmp;
	}
	else if(lua_isboolean(L, -1))
		attribute_value = popBoolean(L);
	else if(lua_isstring(L, -1))
		attribute_value = popString(L);
	else
	{
		lua_pop(L, 1);
    ...
    std::string attribute_key = popString(L);
	int32_t itemId = (int32_t)popNumber(L);
	bool deepSearch = popNumber(L);
	...
	Item* item = g_game.findItemOfTypeWithAttribute(player, itemId, deepSearch, subType, attribute_key, attribute_value);
	if(!item)
	{
		pushThing(L, NULL, 0);
		return 1;
...
int32_t LuaScriptInterface::luaGetPlayerItemByAttribute(lua_State* L)
{
    //getPlayerItemByAttribute(cid, deepSearch, attribute_key, attribute_value)        
	ScriptEnviroment* env = getEnv();
	...
	Item* item = g_game.findItemOfAttribute(player, deepSearch, attribute_key, attribute_value);
	if(!item)
	{
		pushThing(L, NULL, 0);
		return 1;
...
int32_t LuaScriptInterface::luaCreateConditionObject(lua_State* L)
{
	...
	bool conditionIdDefault = false;
	if(params > 4)
	    conditionIdDefault = popBoolean(L);
	...
	if(conditionIdDefault)
        condition = Condition::createCondition(CONDITIONID_DEFAULT, (ConditionType_t)popNumber(L), ticks, 0, buff, subId);
	else
        condition = Condition::createCondition(CONDITIONID_COMBAT, (ConditionType_t)popNumber(L), ticks, 0, buff, subId);
...
{
	//doSummonMonster(cid, name[, forced, position])
	PositionEx pos;
    if (lua_gettop(L) > 3) {
	    popPosition(L, pos);
    }
	...
	lua_pushnumber(L, g_game.placeSummon(creature, name, forced, &pos));
	return 1;
}
...
int32_t LuaScriptInterface::luaGetMonsterSex(lua_State* L)
{
	//getMonsterSex(cid)
	ScriptEnviroment* env = getEnv();
	Creature* creature = env->getCreatureByUID(popNumber(L));
	...
	lua_pushnumber(L, monster->getSex());
	return 1;
}

int32_t LuaScriptInterface::luaSetMonsterSex(lua_State* L)
{
	//setMonsterSex(cid, newSex)
	uint32_t newSex = popNumber(L);
	...
	monster->setSex(newSex);
	g_game.updateCreatureSkull(creature);
	return 1;
}

int32_t LuaScriptInterface::luaGetMonsterLevel(lua_State* L)
{
	//getMonsterLevel(cid)
	ScriptEnviroment* env = getEnv();
	Creature* creature = env->getCreatureByUID(popNumber(L));
...
int32_t LuaScriptInterface::luaSetMonsterLevel(lua_State* L)
{
	//setMonsterLevel(cid, newLevel)
	uint32_t newLevel = popNumber(L);
...
int32_t LuaScriptInterface::luaSetMonsterExtraPoints(lua_State* L)
{
	//setMonsterExtraPoints(cid, newExtraPoints)
	uint32_t newExtraPoints = popNumber(L);
	...
	monster->setExtraPoints(newExtraPoints);
	return 1;
}

int32_t LuaScriptInterface::luaGetMonsterExtraPoints(lua_State* L)
{
	//getMonsterExtraPoints(cid)	
	ScriptEnviroment* env = getEnv();
	Creature* creature = env->getCreatureByUID(popNumber(L));
	if(!creature)
	{
    ...
    lua_pushnumber(L, monster->getExtraPoints());  
	return 1;
}

int32_t LuaScriptInterface::luaGetMonsterExtraSpAtk(lua_State* L)
{
	//getMonsterExtraSpAtk(cid)
	ScriptEnviroment* env = getEnv();
	Creature* creature = env->getCreatureByUID(popNumber(L));
	if(!creature)
	{
	...
	lua_pushnumber(L, monster->getExtraSpAtk());
	return 1;
}

int32_t LuaScriptInterface::luaDoMonsterAddExtraSpAtk(lua_State* L)
{
	//doMonsterAddExtraSpAtk(cid, amount)
	int amount = popNumber(L);
	...
	if(!monster)
	{
   	...
   	monster->addExtraSpAtk(amount);
	return 1;
}

int32_t LuaScriptInterface::luaGetMonsterExtraSpDef(lua_State* L)
{
	//getMonsterExtraSpDef(cid)
	ScriptEnviroment* env = getEnv();
	Creature* creature = env->getCreatureByUID(popNumber(L));
	if(!creature)
	{
	...
	lua_pushnumber(L, monster->getExtraSpDef());
	return 1;
}

int32_t LuaScriptInterface::luaDoMonsterAddExtraSpDef(lua_State* L)
{
	//doMonsterAddExtraSpDef(cid, amount)
	int amount = popNumber(L);
...
int32_t LuaScriptInterface::luaDoCreatureSetTarget(lua_State* L)
{
	//doCreatureSetTarget(cid, target)
	uint32_t targetId = popNumber(L);
	ScriptEnviroment* env = getEnv();
...
int32_t LuaScriptInterface::luaGetMonsterInfo(lua_State* L)
{
	...
	setField(L, "nickname", mType->nickname);
	setField(L, "sex", mType->sex);
	setField(L, "shiny", mType->shiny);
	setField(L, "minLevel", mType->minLevel);
	setField(L, "maxLevel", mType->maxLevel);
	...
	setFieldBool(L, "pacific", mType->isPacific);
	setFieldBool(L, "catchable", mType->isCatchable);
...
int32_t LuaScriptInterface::luaGetTalkActionList(lua_State* L)
{
	...
	for(uint32_t i = 1; it != g_talkActions->getLastTalk(); ++it, ++i)
	{
		...
		setField(L, "description", it->second->getDescription());
...
int32_t LuaScriptInterface::luaSetCreatureOutfit(lua_State* L)
{
	...
	ScriptEnviroment* env = getEnv();
	if(Creature* creature = env->getCreatureByUID(popNumber(L)))
		lua_pushboolean(L, Spell::CreateIllusion(creature, outfit, time, subId) == RET_NOERROR);
	else
	{
		errorEx(getError(LUA_ERROR_CREATURE_NOT_FOUND));
		lua_pushboolean(L, false);
...
int32_t LuaScriptInterface::luaSetItemUniqueOwner(lua_State* L)
{
	//setItemUniqueOwner(item, owner[, guid])
	uint32_t guid = 0;
    if (lua_gettop(L) > 2) {
		guid = (uint32_t)popNumber(L);
    }
	
	ScriptEnviroment* env = getEnv();
	
	Player* player = env->getPlayerByUID(popNumber(L));
	if (!player && guid == 0) { // We only need the player when no guid was given
	    errorEx(getError(LUA_ERROR_PLAYER_NOT_FOUND));
		lua_pushboolean(L, false);
		return 1;
    }
...
int32_t LuaScriptInterface::luaGetTempStorage(lua_State* L)
{
	//getTempStorage(key)
	ScriptEnviroment* env = getEnv();
	std::string strValue;
	if(env->getTempStorage(popString(L), strValue))
	{
		int32_t intValue = atoi(strValue.c_str());
		if(intValue || strValue == "0")
			lua_pushnumber(L, intValue);
...
int32_t LuaScriptInterface::luaSetTempStorage(lua_State* L)
{
	...
	ScriptEnviroment* env = getEnv();
	if(!nil)
		env->setTempStorage(popString(L), value);
	else
		env->eraseTempStorage(popString(L));
...
int32_t LuaScriptInterface::luaGetContainerItemByIndex(lua_State* L)
  {
  	//getContainerItemByIndex(cid, container_index, slot_index)
  	uint32_t slot_index = popNumber(L);
  	uint32_t container_index = popNumber(L);
  	uint32_t cid = popNumber(L);
  
  	ScriptEnviroment* env = getEnv();
  	if (Player* player = env->getPlayerByUID(cid)) {
  		if (Container* container = player->getContainer(container_index)) {
  			if (Item* item = container->getItem(slot_index)) {
  				pushThing(L, item, env->addThing(item));
  			}
  			else {
  				pushThing(L, NULL, 0);
...
int32_t LuaScriptInterface::luaDoMovePlayerItem(lua_State* L)
{
	//doMovePlayerItem(cid, itemuid, toPosition[, indexWhereever = false])
	bool indexWhereever = false;
	if(lua_gettop(L) > 3)
		indexWhereever = popNumber(L);
		
	PositionEx toPosition;
	popPosition(L, toPosition);
	ScriptEnviroment* env = getEnv();
    ...
    if (indexWhereever)
        g_game.internalMoveItem(player, item->getParent(), player, INDEX_WHEREEVER,	item, item->getItemCount(), NULL, FLAG_NOLIMIT);
    ...
    {    
        ...
        g_game.internalMoveItem(player, item->getParent(), player, toIndex,	item, item->getItemCount(), NULL, FLAG_NOLIMIT);
    }
    lua_pushboolean(L, true);
	return 1;
}

int32_t LuaScriptInterface::luaDoPlayerUseItem(lua_State* L)
{
	//doPlayerUseItem(cid, itemuid)		
	ScriptEnviroment* env = getEnv();
    ...
    Player* player = env->getPlayerByUID(playerId);
	if(!player)
	{
        errorEx(getError(LUA_ERROR_PLAYER_NOT_FOUND));
        lua_pushboolean(L, false);
    ...
    if(g_actions->useItem(player, player->getPosition(), 0, item, true))
        lua_pushboolean(L, true);
    else
        lua_pushboolean(L, false);
...
int32_t LuaScriptInterface::luaGetCreatureNickname(lua_State* L)
{
	//getCreatureNickname(cid)
	ScriptEnviroment* env = getEnv();
	if(Creature* creature = env->getCreatureByUID(popNumber(L)))
		lua_pushstring(L, creature->getNickname().c_str());
	else
	{
		errorEx(getError(LUA_ERROR_CREATURE_NOT_FOUND));
		lua_pushboolean(L, false);
...
int32_t LuaScriptInterface::luaSetCreatureNickname(lua_State* L)
{
	//getSreatureNickname(cid, nickname)
	std::string newNickname = popString(L);

	ScriptEnviroment* env = getEnv();
	if(Creature* creature = env->getCreatureByUID(popNumber(L)))
	{
		creature->setNickname(newNickname);
		lua_pushboolean(L, true);
	}
	else
	{
...
int32_t LuaScriptInterface::luaDoPlayerSetGroupId(lua_State* L)
{
	...
	if(Player* player = env->getPlayerByUID(popNumber(L)))
	{
		if(Group* group = Groups::getInstance()->getGroup(groupId))
		{
	        ...
	        if(!list.empty())
            {
                SpectatorVec::const_iterator it = list.begin(); // PS force the monster see the player, bug fix
                for(uint32_t i = 1; it != list.end(); ++it, ++i)
	            {
                     if(Monster* monster = (*it)->getMonster())
                         monster->onCreatureAppear(player);
                }
	        }
...
int32_t LuaScriptInterface::luaSetPlayerMagicLevel(lua_State* L)
{
	//setPlayerMagicLevel(cid, newMagicLevel)
	int32_t newMagicLevel = popNumber(L);
...
int32_t LuaScriptInterface::luaSetPlayerMagicLevelPercent(lua_State* L)
{
	//setPlayerMagicLevelPercent(cid, newMagicLevelPercent)
	int32_t newMagicLevelPercent = popNumber(L);

	ScriptEnviroment* env = getEnv();
	if(Player* player = env->getPlayerByUID(popNumber(L)))
	{
		player->setMagicLevelPercent(newMagicLevelPercent);
		lua_pushboolean(L, true);
	}
	else
	{
...
int32_t LuaScriptInterface::luaDoItemSetCount(lua_State* L)
{
	//doItemSetCount(uid, value)
	uint8_t value;
	if(lua_isnumber(L, -1))
...
int32_t LuaScriptInterface::luaDoItemSetSpecialDescription(lua_State* L)
{
	//doItemSetSpecialDescription(uid, desc)
...
int32_t LuaScriptInterface::luaResultGetDataStream(lua_State* L)
{
	...
	lua_newtable(L);
	setField(L, "data", res->getDataStream(s, length));
    setField(L, "length", length);
	return 1;
}
...
int32_t LuaScriptInterface::luaGetPlayerAutoTrade(lua_State* L)
{
	//getPlayerAutoTrade(cid)
	ScriptEnviroment* env = getEnv();
	Player* player = env->getPlayerByUID((uint32_t)popNumber(L));
	if(!player)
	{
		...
		lua_pushboolean(L, player->getAutoTrade());

	return 1;
}

int32_t LuaScriptInterface::luaSetPlayerAutoTrade(lua_State* L)
{
	//setPlayerAutoTrade(cid, autoTrade)
	uint32_t autoTrade = popBoolean(L);

	ScriptEnviroment* env = getEnv();
	if(Player* player = env->getPlayerByUID(popNumber(L)))
	{
		player->setAutoTrade(autoTrade);
		lua_pushboolean(L, true);
	}
	else
	{
...
int32_t LuaScriptInterface::luaDoPlayerTalkOnChannel(lua_State* L)
{
	//doPlayerTalkOnChannel(cid, message, speakClass, channelId)
	uint16_t channelId = popNumber(L);
	uint32_t speakClass = popNumber(L);
	...
	g_game.publicPlayerTalkToChannel(player, (SpeakClasses)speakClass, message, channelId);
	lua_pushboolean(L, true);
	return 1;
}

int32_t LuaScriptInterface::luaDoPlayerSendChannelsDialog(lua_State* L)
{
	//doPlayerSendChannelsDialog(cid, channelsIds)
	std::vector<uint16_t> channelsIds;
	lua_pushnil(L);
	while(lua_next(L, -2))
	{
        channelsIds.push_back((uint16_t)lua_tonumber(L, -1));
		lua_pop(L, 1);
	}
	lua_pop(L, 1);
	...
	if(Player* player = env->getPlayerByUID(popNumber(L)))
	{
		player->sendChannelsDialog(channelsIds);
		lua_pushboolean(L, true);
	}
	else
	{
...
int32_t LuaScriptInterface::luaDoPlayerJoinChannel(lua_State* L)
{
	//doPlayerJoinChannel(cid, channelId)
	if(ChatChannel* channel = g_chat.getChannelById((uint16_t)popNumber(L)))
	{
        ScriptEnviroment* env = getEnv();
	    if(Player* player = env->getPlayerByUID(popNumber(L)))
	    {
    ...
    {
        errorEx(getError(LUA_ERROR_CHANNEL_NOT_FOUND));
        lua_pushboolean(L, false);
    }
...
int32_t LuaScriptInterface::luaDoPlayerLeaveChannel(lua_State* L)
{
	//doPlayerLeaveChannel(cid, channelId)
	if(ChatChannel* channel = g_chat.getChannelById((uint16_t)popNumber(L)))
	{
...
int32_t LuaScriptInterface::luaDoPlayerSendTVChannelsDialog(lua_State* L)
{
	//doPlayerSendTVChannelsDialog(cid)   
    ScriptEnviroment* env = getEnv();
	if(Player* player = env->getPlayerByUID(popNumber(L)))
	{
		player->sendTVChannelsDialog();
		lua_pushboolean(L, true);
	}
	else
	{
...
int32_t LuaScriptInterface::luaDoPlayerCreateTVChannel(lua_State* L)
{
	//doPlayerCreateTVChannel(cid)   
    ScriptEnviroment* env = getEnv();
	if(Player* player = env->getPlayerByUID(popNumber(L)))
	{
		if(ChatChannel* tvChannel = g_chat.createChannel(player, CHANNEL_TV))
		    lua_pushnumber(L, tvChannel->getId());
        else
            lua_pushboolean(L, false);
	}
	else
...
int32_t LuaScriptInterface::luaDoPlayerDeleteTVChannel(lua_State* L)
{
	//doPlayerDeleteTVChannel(cid)   
    ScriptEnviroment* env = getEnv();
	if(Player* player = env->getPlayerByUID(popNumber(L)))
	{
		g_chat.deleteChannel(player, CHANNEL_TV);
		lua_pushboolean(L, true);
	}
	else
	{
...
int32_t LuaScriptInterface::luaGetPlayerRecordingTV(lua_State* L)
{
	//getPlayerRecordingTV(cid)
    ScriptEnviroment* env = getEnv();
	if(Player* player = env->getPlayerByUID(popNumber(L)))
		lua_pushboolean(L, player->getRecordingTV());
	else
	{
		errorEx(getError(LUA_ERROR_PLAYER_NOT_FOUND));
		lua_pushboolean(L, false);
...
int32_t LuaScriptInterface::luaGetPlayerWatchingTV(lua_State* L)
{
	//getPlayerWatchingTV(cid)
    ScriptEnviroment* env = getEnv();
	if(Player* player = env->getPlayerByUID(popNumber(L)))
		lua_pushboolean(L, player->getWatchingTV());
	else
	{
		errorEx(getError(LUA_ERROR_PLAYER_NOT_FOUND));
		lua_pushboolean(L, false);
...
int32_t LuaScriptInterface::luaGetPlayerTVChannelId(lua_State* L)
{
	//getPlayerTVChannelId(cid)
    ScriptEnviroment* env = getEnv();
	if(Player* player = env->getPlayerByUID(popNumber(L)))
...
int32_t LuaScriptInterface::luaSetTVChannelName(lua_State* L)
{
    //setTVChannelName(cid, newChannelName)
    std::string newChannelName = popString(L);
    ScriptEnviroment* env = getEnv();
    if(Player* player = env->getPlayerByUID(popNumber(L)))
	{
        if(TVChannel* tvChannel = g_chat.getTVChannel(player))
        {
            tvChannel->setName(newChannelName);
            lua_pushboolean(L, true);
            return 1;
        }
        else
...
int32_t LuaScriptInterface::luaGetTVChannelViewers(lua_State* L)
{
	//getTVChannelViewers(tvChannelId)
    ScriptEnviroment* env = getEnv();
	if(Player* player = env->getPlayerByUID(popNumber(L)))
	{
        if(TVChannel* tvChannel = g_chat.getTVChannel(player))
        {
            ViewersList viewersList = tvChannel->getViewers();
		    ViewersList::iterator it = viewersList.begin();

		    lua_newtable(L);
		    for(int32_t i = 1; it != viewersList.end(); ++it, ++i)
		    {
			    lua_pushnumber(L, i);
			    lua_pushnumber(L, env->addThing(*it));
			    pushTable(L);
...
int32_t LuaScriptInterface::luaDoPlayerLeaveTVChannel(lua_State* L)
{
	//doPlayerLeaveTVChannel(tvChannelId, playerId)
	ScriptEnviroment* env = getEnv();
	if(Player* kicked = env->getPlayerByUID(popNumber(L)))
	{
        if(TVChannel* tvChannel = g_chat.getTVChannelById((uint16_t)popNumber(L)))
            lua_pushboolean(L, tvChannel->removeUser(kicked));
        else
        {
            errorEx(getError(LUA_ERROR_CHANNEL_NOT_FOUND));
		    lua_pushboolean(L, false);
...
int32_t LuaScriptInterface::luaDoTVChannelBan(lua_State* L)
{
	//doTVChannelBan(tvChannelId, playerId)
	ScriptEnviroment* env = getEnv();
	if(Player* banned = env->getPlayerByUID(popNumber(L)))
	{
        if(TVChannel* tvChannel = g_chat.getTVChannelById((uint16_t)popNumber(L)))
            lua_pushboolean(L, tvChannel->banViewer(banned));
        else
        {
            errorEx(getError(LUA_ERROR_CHANNEL_NOT_FOUND));
		    lua_pushboolean(L, false);
...
int32_t LuaScriptInterface::luaDoTVChannelUnban(lua_State* L)
{
	//doTVChannelUnban(tvChannelId, playerId)
	ScriptEnviroment* env = getEnv();
	if(Player* unbanned = env->getPlayerByUID(popNumber(L)))
	{
        if(TVChannel* tvChannel = g_chat.getTVChannelById((uint16_t)popNumber(L)))
            lua_pushboolean(L, tvChannel->unbanViewer(unbanned));
        else
        {
            errorEx(getError(LUA_ERROR_CHANNEL_NOT_FOUND));
		    lua_pushboolean(L, false);
...
int32_t LuaScriptInterface::luaGetPlayerDueling(lua_State* L)
{
	//getPlayerDueling(cid)
	ScriptEnviroment* env = getEnv();
	if(const Player* player = env->getPlayerByUID(popNumber(L)))
	    lua_pushboolean(L, player->getDueling());
    else
    {
        errorEx(getError(LUA_ERROR_PLAYER_NOT_FOUND));
        lua_pushboolean(L, false);
...
int32_t LuaScriptInterface::luaGetPlayerDuelPokemonRemaing(lua_State* L)
{
    //getPlayerDuelPokemonRemaing(cid)
	ScriptEnviroment* env = getEnv();
	if(Player* player = env->getPlayerByUID(popNumber(L)))
	    lua_pushnumber(L, player->getDuelPokemonRemaing());
    else
    {
        errorEx(getError(LUA_ERROR_PLAYER_NOT_FOUND));
        lua_pushboolean(L, false);
...
int32_t LuaScriptInterface::luaSetPlayerDuelPokemonRemaing(lua_State* L)
{
	//setPlayerDuelPokemonRemaing(cid, _duelPokemonRemaing)
	uint8_t _duelPokemonRemaing = (uint8_t)popNumber(L);
	ScriptEnviroment* env = getEnv();
	if(Player* player = env->getPlayerByUID(popNumber(L)))
	{
        player->setDuelPokemonRemaing(_duelPokemonRemaing, false);
		lua_pushboolean(L, true);
	}
	else
	{
...
int32_t LuaScriptInterface::luaGetPlayerPartyDuel(lua_State* L)
{
	//getPlayerPartyDuel(cid)
	ScriptEnviroment* env = getEnv();
	if(Player* player = env->getPlayerByUID(popNumber(L)))
	{
		if(PartyDuel* partyDuel = player->getPartyDuel())
			lua_pushnumber(L, env->addThing(partyDuel->getLeaderA()));
		else
			lua_pushnil(L);
	}
	else
...
int32_t LuaScriptInterface::luaDoPartyDuelJoin(lua_State* L)
{
	//doPartyDuelJoin(leader, invited)
	ScriptEnviroment* env = getEnv();
	Player* invited = env->getPlayerByUID(popNumber(L));
	if(!invited)
	{
		errorEx(getError(LUA_ERROR_PLAYER_NOT_FOUND));
		lua_pushboolean(L, false);
	...
	g_game.partyDuelJoin(leader->getID(), invited->getID());
	lua_pushboolean(L, true);
	return 1;
}

int32_t LuaScriptInterface::luaDoPartyDuelInvite(lua_State* L)
{
	//doPartyDuelInvite(leader, invited)
	ScriptEnviroment* env = getEnv();
	Player* invited = env->getPlayerByUID(popNumber(L));
	...
	g_game.partyDuelInvite(leader->getID(), invited->getID());
	lua_pushboolean(L, true);
	return 1;
}

int32_t LuaScriptInterface::luaDoPartyDuelLeave(lua_State* L)
{
	//doPartyDuelLeave(cid)
	ScriptEnviroment* env = getEnv();
	Player* player = env->getPlayerByUID(popNumber(L));
	...
	g_game.partyDuelLeave(player->getID());
	lua_pushboolean(L, true);
	return 1;
}

int32_t LuaScriptInterface::luaDoPartyDuelCreate(lua_State* L)
{
	//doPartyDuelCreate(leader, maxMembers, maxPokemon, bet)
	uint32_t bet = (uint32_t)popNumber(L);
	uint8_t maxPokemon = (uint8_t)popNumber(L);
	uint8_t maxMembers = (uint8_t)popNumber(L);
	...
	g_game.partyDuelCreate(leader->getID(), maxMembers, maxPokemon, true, NULL, bet);
	lua_pushboolean(L, true);
	return 1;
}

int32_t LuaScriptInterface::luaGetPartyDuelPartners(lua_State* L)
{
	//getPartyDuelPartners(cid)
	ScriptEnviroment* env = getEnv();
	if(Player* player = env->getPlayerByUID(popNumber(L)))
	{
		if(PartyDuel* partyDuel = player->getPartyDuel())
		{
			PlayerVector list = partyDuel->getPartners(player);
			PlayerVector::const_iterator it = list.begin();
			lua_newtable(L);
			for(uint32_t i = 1; it != list.end(); ++it, ++i)
			{
...
int32_t LuaScriptInterface::luaCanDoCombat(lua_State* L)
{
	//canDoCombat(fromCid, toCid)
	ScriptEnviroment* env = getEnv();
	const Creature* toCid = env->getCreatureByUID(popNumber(L));
	if(!toCid)
	{
		errorEx(getError(LUA_ERROR_CREATURE_NOT_FOUND));
		lua_pushboolean(L, false);
	...
	const Creature* fromCid = env->getCreatureByUID(popNumber(L));
	if(!fromCid)
	{
		errorEx(getError(LUA_ERROR_CREATURE_NOT_FOUND));
		lua_pushboolean(L, false);
	...
	lua_pushnumber(L, Combat::canDoCombat(fromCid, toCid));
	return 1;
}
...
int32_t LuaScriptInterface::luaGetPlayerBattleing(lua_State* L)
{
	//getPlayerBattleing(cid)
	ScriptEnviroment* env = getEnv();
	if(Player* player = env->getPlayerByUID(popNumber(L)))
	    lua_pushboolean(L, player->getBattleing());
    else
    {
        errorEx(getError(LUA_ERROR_PLAYER_NOT_FOUND));
        lua_pushboolean(L, false);
...
int32_t LuaScriptInterface::luaSetPlayerBattleing(lua_State* L)
{
	//setPlayerBattleing(cid, _battleing)
	bool _battleing = popBoolean(L);
	ScriptEnviroment* env = getEnv();
	if(Player* player = env->getPlayerByUID(popNumber(L)))
	{
	    player->setBattleing(_battleing);
	    lua_pushboolean(L, true);
    }
    else
    {
...
{
	//doCreatureCastSpell(cid, spellName[, target])
	Creature* target = NULL;
	ScriptEnviroment* env = getEnv();
	if(lua_gettop(L) > 2)
	{
        target = env->getCreatureByUID(popNumber(L));
        if(!target)
        {
            errorEx(getError(LUA_ERROR_CREATURE_NOT_FOUND));
            lua_pushboolean(L, false);
	...
	if(InstantSpell* instantSpell = g_spells->getInstantSpellByName(popString(L)))
	{
        if(Creature* creature = env->getCreatureByUID(popNumber(L)))
        {        
            if(target)
                lua_pushboolean(L, instantSpell->castSpell(creature, target));
            else
                lua_pushboolean(L, instantSpell->castSpell(creature));
        }
        else
        {
            errorEx(getError(LUA_ERROR_CREATURE_NOT_FOUND));
...
int32_t LuaScriptInterface::luaDoCreatureChangeHealth(lua_State* L)
{
	//doCreatureChangeHealth(cid, healthChange)
	int32_t healthChange = popNumber(L);
	ScriptEnviroment* env = getEnv();
...
int32_t LuaScriptInterface::luaDoPvpArenaJoin(lua_State* L)
{
	//doPvpArenaJoin(cid, arenaId, teamId)
	uint8_t teamId = popNumber(L);
	uint8_t arenaId = popNumber(L);
	
	ScriptEnviroment* env = getEnv();
	if(Player* player = env->getPlayerByUID(popNumber(L)))
        lua_pushboolean(L, g_game.pvpArenaJoin(player->getID(), arenaId, teamId));
	else
	{
        errorEx(getError(LUA_ERROR_PLAYER_NOT_FOUND));
		lua_pushboolean(L, false);
...
int32_t LuaScriptInterface::luaDoPvpArenaLeave(lua_State* L)
{
	//doPvpArenaLeave(cid)
	ScriptEnviroment* env = getEnv();
	if(Player* player = env->getPlayerByUID(popNumber(L)))
		lua_pushboolean(L, g_game.pvpArenaLeave(player->getID()));
    else
    {
        errorEx(getError(LUA_ERROR_PLAYER_NOT_FOUND));
		lua_pushboolean(L, false);
...
int32_t LuaScriptInterface::luaDoPvpArenaCreate(lua_State* L)
{
	//doPvpArenaCreate(arenaId, blueSpawnPosition, redSpawnPosition, exitPosition, maxLevel, blueChannel, redChannel)	
    uint16_t redChannel = popNumber(L);
    uint16_t blueChannel = popNumber(L);
    uint32_t maxLevel = popNumber(L);
	PositionEx exit, redSpawn, blueSpawn;
    popPosition(L, exit);
	popPosition(L, redSpawn);
	popPosition(L, blueSpawn);
	uint8_t arenaId = popNumber(L);

	lua_pushboolean(L, (bool)g_game.pvpArenaCreate(arenaId, blueSpawn, redSpawn, exit, maxLevel, blueChannel, redChannel));
	return 1;
}

int32_t LuaScriptInterface::luaGetPlayerPvpArena(lua_State* L)
{
	//getPlayerPvpArena(cid)
	ScriptEnviroment* env = getEnv();
	if(Player* player = env->getPlayerByUID(popNumber(L)))
		lua_pushboolean(L, (bool)player->getPvpArena());
    else
    {
        errorEx(getError(LUA_ERROR_PLAYER_NOT_FOUND));
		lua_pushboolean(L, false);
...
int32_t LuaScriptInterface::luaGetPvpArenaUsersCount(lua_State* L)
{
	//getPvpArenaUsersCount(arenaId)
	if(PvpArena* pvpArena = g_game.getPvpArenaById(popNumber(L)))
	{
        lua_newtable(L);
        setField(L, "blue", pvpArena->getBlueUsersCount());
        setField(L, "red", pvpArena->getRedUsersCount());
    }
    else
        lua_pushnil(L);
	return 1;
...
int32_t LuaScriptInterface::luaGetPvpArenaUsers(lua_State* L)
{
	//getPvpArenaUsers(arenaId)
	if(PvpArena* pvpArena = g_game.getPvpArenaById(popNumber(L))) {
        PlayerVector list = pvpArena->getUsers();
	    PlayerVector::const_iterator it = list.begin();
	    lua_newtable(L);
	    for(uint32_t i = 1; it != list.end(); ++it, ++i) {
            lua_pushnumber(L, i);
...
int32_t LuaScriptInterface::luaGetPlayerPvpArenaTeam(lua_State* L)
{
	//getPlayerPvpArenaTeam(cid)
	ScriptEnviroment* env = getEnv();
	if (Player* player = env->getPlayerByUID(popNumber(L))) {
        lua_pushnumber(L, (uint8_t)player->getPvpArenaTeam());
    } else {
        errorEx(getError(LUA_ERROR_PLAYER_NOT_FOUND));
        lua_pushnil(L);
    }           
...
int32_t LuaScriptInterface::luaDoNpcSetOpponent(lua_State* L)
{
	//doNpcSetOpponent(npc, player)
	ScriptEnviroment* env = getEnv();
	if(Player* player = env->getPlayerByUID(popNumber(L)))
	{	
        if(Creature* creature = env->getCreatureByUID(popNumber(L)))
...
int32_t LuaScriptInterface::luaGetPlayerExtraLootRate(lua_State* L)
{
    //getPlayerExtraLootRate(cid)
    ScriptEnviroment* env = getEnv();
    if(Player* player = env->getPlayerByUID(popNumber(L)))
...
int32_t LuaScriptInterface::luaSetPlayerExtraLootRate(lua_State* L)
{
    //setPlayerExtraLootRate(cid, value)
    float value = popFloatNumber(L);
    ScriptEnviroment* env = getEnv();
...
int32_t LuaScriptInterface::luaGetTournamentInfo(lua_State* L)
{
    //getTournamentInfo(id)
    Tournament* tournament = Tournaments::getInstance()->getTournament(popNumber(L));
    if(!tournament)
    {
//        errorEx(getError(LUA_ERROR_TOURNAMENT_NOT_FOUND));
        lua_pushboolean(L, false);
        return 1;
    }
    
    lua_newtable(L);
    setField(L, "name", tournament->getName().c_str());
    setField(L, "capacity", tournament->getCapacity());
    setField(L, "interval", tournament->getInverval());
    setField(L, "minLevel", tournament->getMinLevel());
    setField(L, "maxLevel", tournament->getMaxLevel());
    setField(L, "inscriptionPrice", tournament->getInscriptionPrice());
    setField(L, "freeCapacity", tournament->getFreeCapacity());
    setField(L, "date", tournament->getDate());
    setFieldBool(L, "started", tournament->getStarted());
    setField(L, "type", tournament->getType());
    setField(L, "minTrainerLevel", tournament->getMinTrainerLevel());
	return 1;
}

int32_t LuaScriptInterface::luaDoTournamentJoin(lua_State* L)
{
    //doTournamentJoin(cid, tournamentId)
    uint8_t tournamentId = popNumber(L);
    ScriptEnviroment* env = getEnv();
    if(Player* player = env->getPlayerByUID(popNumber(L)))
    {
        if(Tournament* tournament = Tournaments::getInstance()->getTournament(tournamentId))
        {
            lua_pushboolean(L, tournament->join(player->getGUID(), player->getAccount()));
            return 1;
        }
        else
            errorEx(getError(LUA_ERROR_TOURNAMENT_NOT_FOUND));
...
int32_t LuaScriptInterface::luaDoTournamentLeave(lua_State* L)
{
    //doTournamentLeave(cid, tournamentId)
    uint8_t tournamentId = popNumber(L);
    ScriptEnviroment* env = getEnv();
    if(Player* player = env->getPlayerByUID(popNumber(L)))
    {
        if(Tournament* tournament = Tournaments::getInstance()->getTournament(tournamentId))
        {
            lua_pushboolean(L, tournament->leave(player));
            return 1;
        }
        else
            errorEx(getError(LUA_ERROR_TOURNAMENT_NOT_FOUND));
...
int32_t LuaScriptInterface::luaGetTournamentLastId(lua_State* L)
{
    //getTournamentLastId()
    lua_pushnumber(L, Tournaments::getInstance()->getLastTournamentId());
    return 1;
}

int32_t LuaScriptInterface::luaGetPlayerTournamentInscribed(lua_State* L)
{
    //getPlayerTournamentInscribed(cid)
    ScriptEnviroment* env = getEnv();
    if(Player* player = env->getPlayerByUID(popNumber(L)))
    {
        lua_pushboolean(L, IOTournament::getInstance()->isInscribed(player->getGUID()));
        return 1;
    }
    else
        errorEx(getError(LUA_ERROR_PLAYER_NOT_FOUND));
...
int32_t LuaScriptInterface::luaGetPlayerTournamentId(lua_State* L)
{
    //getPlayerTournamentId(cid)
    ScriptEnviroment* env = getEnv();
    if(Player* player = env->getPlayerByUID(popNumber(L)))
    {
        lua_pushnumber(L, IOTournament::getInstance()->getPlayerTournamentId(player->getGUID()));
        return 1;
    }
    else
        errorEx(getError(LUA_ERROR_PLAYER_NOT_FOUND));
...
int32_t LuaScriptInterface::luaGetPlayerActiveTournamentId(lua_State* L)
{
    //getPlayerTournamentId(cid)
    ScriptEnviroment* env = getEnv();
    if(Player* player = env->getPlayerByUID(popNumber(L)))
    {
        ...
        if (tournament) {
            lua_pushnumber(L, tournament->getId());
        } else {
            lua_pushboolean(L, false);
        }
    }
...
int32_t LuaScriptInterface::luaGetPlayerTournamentReady(lua_State* L)
{
    //getPlayerTournamentReady(cid)
    ScriptEnviroment* env = getEnv();
    if(Player* player = env->getPlayerByUID(popNumber(L)))
    {
        lua_pushboolean(L, player->getTournamentReady());
        return 1;
    }
    else
        errorEx(getError(LUA_ERROR_PLAYER_NOT_FOUND));
...
int32_t LuaScriptInterface::luaSetPlayerTournamentReady(lua_State* L)
{
    //setPlayerTournamentReady(cid, ready)
    bool ready = popBoolean(L);
    ScriptEnviroment* env = getEnv();
    if(Player* player = env->getPlayerByUID(popNumber(L)))
        player->setTournamentReady(ready);
    else
        errorEx(getError(LUA_ERROR_PLAYER_NOT_FOUND));
    return 1;
}

int32_t LuaScriptInterface::luaGetPlayerAutoLoot(lua_State* L)
{
    //getPlayerAutoLoot(cid)
    ScriptEnviroment* env = getEnv();
    if(Player* player = env->getPlayerByUID(popNumber(L)))
        lua_pushboolean(L, player->getAutoLoot());
    else
        errorEx(getError(LUA_ERROR_PLAYER_NOT_FOUND));
    return 1;
}

int32_t LuaScriptInterface::luaSetPlayerAutoLoot(lua_State* L)
{
    //setPlayerAutoLoot(cid, autoLoot)
    bool autoLoot = popBoolean(L);
    ScriptEnviroment* env = getEnv();
    if(Player* player = env->getPlayerByUID(popNumber(L)))
        player->setAutoLoot(autoLoot);
    else
        errorEx(getError(LUA_ERROR_PLAYER_NOT_FOUND));
    return 1;
}

int32_t LuaScriptInterface::luaGetCreatureByNickname(lua_State* L)
{
	//getCreatureByNickname(nickname)
	ScriptEnviroment* env = getEnv();
	if(Creature* creature = g_game.getCreatureByNickname(popString(L)))
		lua_pushnumber(L, env->addThing(creature));
	else
		lua_pushnil(L);
...
int32_t LuaScriptInterface::luaGetMonsterSpecialAbility(lua_State* L)
{
	//getMonsterSpecialAbility(cid)
	ScriptEnviroment* env = getEnv();
	if(Creature* creature = env->getCreatureByUID(popNumber(L))) {
        if (Monster* monster = creature->getMonster()) {
            lua_pushnumber(L, monster->getSpecialAbility());
        }
        else {
            errorEx(getError(LUA_ERROR_MONSTER_NOT_FOUND));
            lua_pushnil(L);
...
int32_t LuaScriptInterface::luaSetMonsterSpecialAbility(lua_State* L)
{
	//setMonsterSpecialAbility(cid, ability)
	uint8_t ability = popNumber(L);
	ScriptEnviroment* env = getEnv();
	if(Creature* creature = env->getCreatureByUID(popNumber(L))) {
        if (Monster* monster = creature->getMonster()) {
            monster->setSpecialAbility(ability);
        }
        else {
            errorEx(getError(LUA_ERROR_MONSTER_NOT_FOUND));
        }
...
int32_t LuaScriptInterface::luaDoPlayerSendTmWindow(lua_State* L) // PS
{
	//doPlayerSendTmWindow(cid, tmMove, moves)
	...
	while(lua_next(L, -2))
	{
        moves.push_back((uint16_t)lua_tonumber(L, -1));
		lua_pop(L, 1);
	}
	lua_pop(L, 1);
	
	uint16_t tmMove = popNumber(L);
    	
	ScriptEnviroment* env = getEnv();
	if(Player* player = env->getPlayerByUID(popNumber(L)))
	{
		player->sendTmWindow(tmMove, moves);
		lua_pushboolean(L, true);
	}
	else
	{
...
int32_t LuaScriptInterface::luaGetItemClientId(lua_State* L)
{
	//getItemClientId(itemid)
	const ItemType* item;
	if(!(item = Item::items.getElement(popNumber(L))))
	...
	lua_pushnumber(L, item->clientId);
	return 1;
}

int32_t LuaScriptInterface::luaGetItemServerId(lua_State* L)
{
	//getItemServerId(itemid)
	const ItemType& item = Item::items.getItemIdByClientId(popNumber(L));
	if(!item.id)
	{
		lua_pushboolean(L, false);
		return 1;
...
int32_t LuaScriptInterface::luaGetItemCount(lua_State* L)
{
	//getItemCount(uid)
	ScriptEnviroment* env = getEnv();
	Item* item = env->getItemByUID(popNumber(L));
...
int32_t LuaScriptInterface::luaGetItemUniqueOwner(lua_State* L)
{
	//getItemUniqueOwner(uid)
	ScriptEnviroment* env = getEnv();
	Item* item = env->getItemByUID(popNumber(L));
	...
	lua_pushnumber(L, item->getUniqueOwner());
	return 1;
}

int32_t LuaScriptInterface::luaDoDatalogCaught(lua_State* L)
{
	//doDatalogCaught(cid, pokemonNumber, tries)
	uint32_t tries = popNumber(L);
	uint16_t pokemonNumber = popNumber(L);
    	
	ScriptEnviroment* env = getEnv();
	if(Player* player = env->getPlayerByUID(popNumber(L))) {
		lua_pushboolean(L, IODatalog::getInstance()->logCaught(player->getGUID(), pokemonNumber, tries));
	}
	else
	{
		errorEx(getError(LUA_ERROR_PLAYER_NOT_FOUND));
...
int32_t LuaScriptInterface::luaDoSwapItems(lua_State* L)
{
	//doSwapItems(itemA, itemB)
	ScriptEnviroment* env = getEnv();
	Item* itemA = env->getItemByUID(popNumber(L));
	if(!itemA)
	{
		errorEx(getError(LUA_ERROR_ITEM_NOT_FOUND));
		lua_pushboolean(L, false);
	...
	Item* itemB = env->getItemByUID(popNumber(L));
	if(!itemB)
	{
		errorEx(getError(LUA_ERROR_ITEM_NOT_FOUND));
		lua_pushboolean(L, false);
	...
	lua_pushboolean(L, g_game.swapItems(itemA, itemB) == RET_NOERROR);
	return 1;
}
...
int32_t LuaScriptInterface::luaDoDatalogBossSpawn(lua_State* L)
{
	//doDatalogBossSpawn(worldId, name, pos, date)
	uint64_t date = popNumber(L);
	PositionEx pos;
	popPosition(L, pos);
	std::string name = popString(L);
	uint16_t worldId = popNumber(L);
    
    lua_pushboolean(L, IODatalog::getInstance()->logBossSpawn(worldId, name, pos, date));
	return 1;
}

int32_t LuaScriptInterface::luaGetPlayerSurviveArena(lua_State* L)
{
	//getPlayerSurviveArena(cid)
	ScriptEnviroment* env = getEnv();
	if(Player* player = env->getPlayerByUID(popNumber(L))) {
		lua_pushboolean(L, player->getSurviveArena());
	}
	else
	{
		errorEx(getError(LUA_ERROR_PLAYER_NOT_FOUND));
...
int32_t LuaScriptInterface::luaSetPlayerSurviveArena(lua_State* L)
{
	//setPlayerSurviveArena(cid, value)
	bool value = popBoolean(L);
	ScriptEnviroment* env = getEnv();
	if(Player* player = env->getPlayerByUID(popNumber(L))) {
		player->setSurviveArena(value);
	}
	else
	{
		errorEx(getError(LUA_ERROR_PLAYER_NOT_FOUND));
...
int32_t LuaScriptInterface::luaDoPlayerSendCustomQuestInfo(lua_State* L)
{
	//doPlayerSendCustomQuestInfo(cid, questId, missions)
    ...
    uint16_t questId = popNumber(L);
    
	ScriptEnviroment* env = getEnv();
	if(Player* player = env->getPlayerByUID(popNumber(L))) {
		player->sendCustomQuestInfo(questId, missions);
	}
	else
	{
		errorEx(getError(LUA_ERROR_PLAYER_NOT_FOUND));
...
int32_t LuaScriptInterface::luaDoPlayerAddStatistic(lua_State* L)
{
	//doPlayerAddStatistic(cid, statisticId, value)
	uint32_t value = popNumber(L);
	PlayerStatistic_t statisticId = PlayerStatistic_t(popNumber(L));
	ScriptEnviroment* env = getEnv();
	if(Player* player = env->getPlayerByUID(popNumber(L))) {
		g_game.playerAddStatistic(player, statisticId, value);
	}
	else
	{
		errorEx(getError(LUA_ERROR_PLAYER_NOT_FOUND));
...
int32_t LuaScriptInterface::luaDoDatalogPokeNickChange(lua_State* L)
{
	//doDatalogPokeNickChange(cid, oldNickname, newNickname, date)
	uint64_t date = popNumber(L);
	std::string newNickname = popString(L);
	std::string oldNickname = popString(L);
	ScriptEnviroment* env = getEnv();
	if(Player* player = env->getPlayerByUID(popNumber(L))) {
		lua_pushboolean(L, IODatalog::getInstance()->logPokeNickChange(player->getGUID(), oldNickname, newNickname, date));
	}
	else
	{
		errorEx(getError(LUA_ERROR_PLAYER_NOT_FOUND));
...
int32_t LuaScriptInterface::luaGetItemAttributesBlob(lua_State* L)
{
	//getItemAttributesBlob(uid)
	ScriptEnviroment* env = getEnv();
	if (Item* item = env->getItemByUID(popNumber(L))) {
        PropWriteStream propWriteStream;
		if (item->serializeAttr(propWriteStream)) {
		    uint32_t attributesSize = 0;
		    const char* attributes = propWriteStream.getStream(attributesSize);
		    
		    lua_pushstring(L, Database::getInstance()->escapeBlob(attributes, attributesSize).c_str());
		    return 1;
        }
    }
    else {
...
int32_t LuaScriptInterface::luaDoItemLoadAttributes(lua_State* L)
{
	//doItemLoadAttributes(uid, resultColumn, resultId)
	ScriptEnviroment* env = getEnv();
    DBResult* result = env->getResultByID(popNumber(L));
	if (!result) {
        lua_pushboolean(L, false);
        return 1;
    }
    
    std::string resultColumn = popString(L);
    uint64_t size = 0;
    const char* data = result->getDataStream(resultColumn, size);
	
	if (Item* item = env->getItemByUID(popNumber(L))) {
        PropStream propStream;
        propStream.init(data, size);

        lua_pushboolean(L, item->unserializeAttr(propStream));
    }
    else {
        errorEx(getError(LUA_ERROR_ITEM_NOT_FOUND));
        lua_pushboolean(L, false);
...
int32_t LuaScriptInterface::luaDoDatalogEggGenerate(lua_State* L)
{
	//doDatalogEggGenerate(cid, egg, date, tries)
	uint16_t tries = popNumber(L);
	uint64_t date = popNumber(L);
	std::string egg = popString(L);
	
	ScriptEnviroment* env = getEnv();
	if(Player* player = env->getPlayerByUID(popNumber(L))) {
		lua_pushboolean(L, IODatalog::getInstance()->logEggGenerate(player->getGUID(), egg, date, tries));
	}
	else
	{
		errorEx(getError(LUA_ERROR_PLAYER_NOT_FOUND));
...
int32_t LuaScriptInterface::luaDoItemEraseUniqueOwner(lua_State* L)
{
    //doItemEraseUniqueOwner(uid)
    ScriptEnviroment* env = getEnv();
    if (Item* item = env->getItemByUID(popNumber(L))) {
        item->setUniqueOwner(0);
        lua_pushboolean(L, true);
    }
    else {
        errorEx(getError(LUA_ERROR_ITEM_NOT_FOUND));
...
int32_t LuaScriptInterface::luaIsNpc(lua_State* L)
{
    ...
    ScriptEnviroment* env = getEnv();
    if (Creature* creature = env->getCreatureByUID(popNumber(L))) {
        lua_pushboolean(L, bool(creature->getNpc()));
        return 1;
    }
    lua_pushboolean(L, false);
    return 1;
...
int32_t LuaScriptInterface::luaDoDatalogPokemonLevelUp(lua_State* L)
{
	//doDatalogPokemonLevelUp(cid, pokemonNumber, fromLevel, toLevel, date, position)
	PositionEx pos;
	popPosition(L, pos);
	uint64_t date = popNumber(L);
	uint32_t toLevel = popNumber(L);
	uint32_t fromLevel = popNumber(L);
	uint16_t pokemonNumber = popNumber(L);
	
	ScriptEnviroment* env = getEnv();
	if(Player* player = env->getPlayerByUID(popNumber(L))) {
		lua_pushboolean(L, IODatalog::getInstance()->logPokemonLevelUp(player->getGUID(), pokemonNumber, fromLevel,
                                                                      toLevel, date, pos));
	}
	else
	{
...
int32_t LuaScriptInterface::luaSetPlayerDisconnectAtExit(lua_State* L)
{
	//setPlayerDisconnectAtExit(cid, disconnectAtExit)
	bool disconnectAtExit = popBoolean(L);
	
	ScriptEnviroment* env = getEnv();
	if (Player* player = env->getPlayerByUID(popNumber(L))) {
		player->setDisconnectAtExit(disconnectAtExit);
	}
	else {
		errorEx(getError(LUA_ERROR_PLAYER_NOT_FOUND));
	}
...
int32_t LuaScriptInterface::luaDoCreateGuild(lua_State* L)
{
    //doCreateGuild(cid, guildName)
	std::string guildName = popString(L);
	if (!isValidName(guildName)) {
        lua_pushboolean(L, false);
        return 1;
    }
	...
	if (Player* player = env->getPlayerByUID(popNumber(L))) {
		...
		if (IOGuild::getInstance()->createGuild(player)) {
            lua_pushboolean(L, true);
        }
        else {
            player->setGuildName("");
...
int32_t LuaScriptInterface::luaSetNpcHouser(lua_State* L)
{
    //setNpcHouser(cid, houser)
    bool houser = popBoolean(L);
	
	ScriptEnviroment* env = getEnv();
	if (Creature* creature = env->getCreatureByUID(popNumber(L))) {
        if (Npc* npc = creature->getNpc()) {
            npc->setHouser(houser);
            lua_pushboolean(L, true);
        }
        else {
            errorEx(getError(LUA_ERROR_NPC_NOT_FOUND));
            lua_pushboolean(L, false);
        }
    }
    else {
...
int32_t LuaScriptInterface::luaDoMoveItem(lua_State* L)
{
	//doMoveItem(item, pos[, ignoreNotMoveable])
	bool ignoreNotMoveable = false;
	if (lua_gettop(L) > 2) {
		ignoreNotMoveable = popNumber(L);
    }
    ...
    lua_pushboolean(L, (g_game.internalMoveItem(NULL, item->getParent(), tile, INDEX_WHEREEVER,	item, item->getItemCount(),
        NULL, (ignoreNotMoveable ? FLAG_NOLIMIT | FLAG_IGNORENOTMOVEABLE : FLAG_NOLIMIT)) == RET_NOERROR));
    return 1;
}

int32_t LuaScriptInterface::luaGetHouseByGuildId(lua_State* L)
{
	//getHouseByGuildId(guildId)
	if(House* house = Houses::getInstance()->getHouseByGuildId(popNumber(L)))
		lua_pushnumber(L, house->getId());
	else
		lua_pushnil(L);
	return 1;
...
int32_t LuaScriptInterface::luaGetItemSellPrice(lua_State* L)
{
    //getItemSellPrice(itemId)
	const ItemType* item;
	if(!(item = Item::items.getElement(popNumber(L))))
    ...
    lua_pushnumber(L, item->sellPrice);
    return 1;
}

int32_t LuaScriptInterface::luaSetTVChannelPassword(lua_State* L)
{
    //setTVChannelPassword(cid, password)
    std::string password = popString(L);
    ScriptEnviroment* env = getEnv();
    if(Player* player = env->getPlayerByUID(popNumber(L)))
	{
        if(TVChannel* tvChannel = g_chat.getTVChannel(player))
        {
            lua_pushboolean(L, tvChannel->setPassword(password));
            return 1;
        }
        else
            errorEx(getError(LUA_ERROR_CHANNEL_NOT_FOUND));
...
int32_t LuaScriptInterface::luaDoPlayerAddBalanceByName(lua_State* L)
{
    //doPlayerAddBalanceByName(name, value)
    int32_t value = popNumber(L);
    
    Player* player = g_game.getPlayerByNameEx(popString(L));
	if (!player) {
		errorEx(getError(LUA_ERROR_PLAYER_NOT_FOUND));
        lua_pushboolean(L, false);
        return 1;
...
int32_t LuaScriptInterface::luaDoPlayerAddDepotItemByName(lua_State* L)
{
	//doPlayerAddDepotItemByName(name, itemuid)	
	ScriptEnviroment* env = getEnv();
	Item* item = env->getItemByUID((uint32_t)popNumber(L));
	if (!item) {
		errorEx(getError(LUA_ERROR_ITEM_NOT_FOUND));
		lua_pushboolean(L, false);
		return 1;
    ...
    lua_pushboolean(L, g_game.internalMoveItem(player, item->getParent(), depot, INDEX_WHEREEVER, item,
            item->getItemCount(), NULL, FLAG_NOLIMIT) == RET_NOERROR);
...
int32_t LuaScriptInterface::luaDoPlayerAddDepotItemByNameWithDepotid(lua_State* L)
{
	//doPlayerAddDepotItemByName(name, depotid, itemuid)	
	ScriptEnviroment* env = getEnv();
	Item* item = env->getItemByUID((uint32_t)popNumber(L));
	uint32_t depotid = popNumber(L);
	if (!item) {
...
int32_t LuaScriptInterface::luaGetCreatureDamageRatioByMaster(lua_State* L)
{
	//getCreatureDamageRatioByMaster(cid, master)
	ScriptEnviroment* env = getEnv();
	Creature* master = env->getCreatureByUID(popNumber(L));
	if (!master) {
        errorEx(getError(LUA_ERROR_CREATURE_NOT_FOUND));
        lua_pushboolean(L, false);
        return 1;
    ...
    lua_pushnumber(L, creature->getDamageRatioByMaster(master));
    return 1;
}

int32_t LuaScriptInterface::luaDoGuildCreateRank(lua_State* L)
{
	//doGuildCreateRank(guild, name)
	std::string name = popString(L);
	uint32_t guild = popNumber(L);
	
	if (!IOGuild::getInstance()->guildExists(guild) ||
        IOGuild::getInstance()->getRankIdByName(guild, name)) {
        lua_pushboolean(L, false);
        return 1;
    }

    lua_pushboolean(L, IOGuild::getInstance()->createGuildRank(guild, name));
    return 1;
}

int32_t LuaScriptInterface::luaSetCreatureBaseSpeed(lua_State* L)
{
	//setCreatureBaseSpeed(cid, baseSpeed)
	uint32_t baseSpeed = popNumber(L);
...
int32_t LuaScriptInterface::luaDoPlayerOpenChannel(lua_State* L)
{
    ...
    lua_pushboolean(L, g_game.playerOpenChannel(player->getID(), channel->getId()));
    return 1;
}

int32_t LuaScriptInterface::luaGetGuildRankIdByName(lua_State* L)
{
	//getGuildRankIdByName(guildId, rankName)
	std::string name = popString(L);
    uint32_t guild = popNumber(L);
	...
	if (!IOGuild::getInstance()->guildExists(guild) ||
        IOGuild::getInstance()->getRankIdByName(guild, name)) {
        lua_pushnumber(L, IOGuild::getInstance()->getRankIdByName(guild, name));
        return 1;
    }
...
int32_t LuaScriptInterface::luaGetPlayerUsingOtClient(lua_State* L)
{
	//getPlayerUsingOtClient(cid)
	ScriptEnviroment* env = getEnv();
	Player* player = env->getPlayerByUID(popNumber(L));
...
int32_t LuaScriptInterface::luaDoPlayerSendPokedexInfo(lua_State* L)
{
	//doPlayerSendPokedexInfo(cid, pokemonId, details, moves, effectiveness, families)
	std::string families = popString(L);
	std::string effectiveness = popString(L);
	std::string moves = popString(L);
	std::string details = popString(L);
	uint16_t pokemonId = popNumber(L);
    ...
    player->sendPokedexInfo(pokemonId, details, moves, effectiveness, families);
    lua_pushboolean(L, true);
    return 1;
}
...
int32_t LuaScriptInterface::luaDoCreatureGiveKillersExperience(lua_State* L)
{
	//doCreatureGiveKillersExperience(cid)
	ScriptEnviroment* env = getEnv();
	Creature* creature = env->getCreatureByUID(popNumber(L));
    ...
    creature->giveKillersExperience();
    lua_pushboolean(L, true);
    return 1;
}

int32_t LuaScriptInterface::luaSetCreatureSkillLoss(lua_State* L)
{
	//setCreatureSkillLoss(cid, lossSkill)
	bool lossSkill = popBoolean(L);
    ...
    creature->setLossSkill(lossSkill);
    lua_pushboolean(L, true);
    return 1;
}

int32_t LuaScriptInterface::luaSetMonsterExperienceRate(lua_State* L)
{
	//setMonsterExperienceRate(cid, experienceRate)
	float experienceRate = popFloatNumber(L);
    ...
    monster->setExperienceRate(experienceRate);
    lua_pushboolean(L, true);
    return 1;
}

int32_t LuaScriptInterface::luaDoUpdateMonsterLoot(lua_State* L)
{
	//doUpdateMonsterLoot(loot, name)
	std::string file = getFilePath(FILE_TYPE_OTHER, "monster/" + popString(L));
    ...
    p = xmlNewNode(NULL,(const xmlChar*)"loot");
    xmlAddChild(root, p);
	xmlNodePtr tmp;
	...
	while(lua_next(L, -2))
	{
		tmp = xmlNewNode(NULL,(const xmlChar*)"item");
		xmlSetProp(tmp, (const xmlChar*)"id", (const xmlChar*)getFieldString(L, "id").c_str());
		xmlSetProp(tmp, (const xmlChar*)"countmax", (const xmlChar*)getFieldString(L, "countmax").c_str());
		xmlSetProp(tmp, (const xmlChar*)"chance", (const xmlChar*)getFieldString(L, "chance").c_str());
		xmlAddChild(p, tmp);
	...
	xmlSaveFileEnc(file.c_str(), doc, "UTF-8");
	lua_pushboolean(L, true);
    return 1;
}

int32_t LuaScriptInterface::luaDoPlayerSendCustomOutfitWindow(lua_State* L)
{
	//doPlayerSendCustomOutfitWindow(cid, defaultOutfit, outfits)	
	...
	while(lua_next(L, -2))
	{
    	...
    	tmpOutfit.lookType = getField(L, "lookType");
    	tmpOutfit.name = getFieldString(L, "name");
        
        outfits.push_back(tmpOutfit);
		lua_pop(L, 1);
	}
	lua_pop(L, 1);
	
	Outfit_t defaultOutfit = popOutfit(L);
    
    ScriptEnviroment* env = getEnv();
	if (Player* player = env->getPlayerByUID(popNumber(L))) {
		player->sendCustomOutfitWindow(defaultOutfit, outfits);
		lua_pushboolean(L, true);
	}
	else
	{
...
int32_t LuaScriptInterface::luaSetMonsterVarPokeStat(lua_State* L)
{
	//setMonsterVarPokeStat(cid, pokeStat, modifier)
	float modifier = popFloatNumber(L);
	pokeStats_t pokeStat = (pokeStats_t)popNumber(L);
    ...
    monster->setVarPokeStat(pokeStat, modifier);
    lua_pushboolean(L, true);
    return 1;
}

int32_t LuaScriptInterface::luaGetMonsterVarPokeStat(lua_State* L)
{
	//getMonsterVarPokeStat(cid, pokeStat)
	pokeStats_t pokeStat = (pokeStats_t)popNumber(L);
    ...
    lua_pushnumber(L, monster->getVarPokeStat(pokeStat));
    return 1;
}

int32_t LuaScriptInterface::luaDoSendPlayerDollCaseStatus(lua_State* L)
{
	//doPlayerSendDollCaseStatus(cid, status)
	std::vector<uint8_t> status;
	...
	if(Player* player = env->getPlayerByUID(popNumber(L)))
	{
		player->sendDollCaseStatus(status);
		lua_pushboolean(L, true);
	}
	else
	{
...
int32_t LuaScriptInterface::luaDoSendPlayerDollCaseUpdate(lua_State* L)
{
	//doPlayerSendDollCaseUpdate(cid, pokemonNumber, status)
	uint8_t status = popNumber(L);
    uint16_t pokemonNumber = popNumber(L);
	...
	if(Player* player = env->getPlayerByUID(popNumber(L)))
	{
		player->sendDollCaseUpdate(pokemonNumber, status);
		lua_pushboolean(L, true);
	}
	else
	{
...
int32_t LuaScriptInterface::luaDoSendPlayerSlotMachine(lua_State* L)
{
	//doPlayerSendSlotMachine(cid, result1, result2, result3)
	uint8_t result3 = popNumber(L);
	uint8_t result2 = popNumber(L);
	uint8_t result1 = popNumber(L);
    	
	ScriptEnviroment* env = getEnv();
	if(Player* player = env->getPlayerByUID(popNumber(L)))
	{
		player->sendSlotMachine(result1, result2, result3);
		lua_pushboolean(L, true);
	}
	else
	{
...
int32_t LuaScriptInterface::luaDoSendPlayerMarketEnter(lua_State* L)
{
	//doPlayerSendMarketEnter(cid)    	
	ScriptEnviroment* env = getEnv();
	if(Player* player = env->getPlayerByUID(popNumber(L)))
...
int32_t LuaScriptInterface::luaDoCreatureDie(lua_State* L)
{
	//doCreatureDie(cid)    	
	ScriptEnviroment* env = getEnv();
	if (Creature* creature = env->getCreatureByUID(popNumber(L))) {
...
int32_t LuaScriptInterface::luaDoSendPlayerTip(lua_State* L)
{
	//doPlayerSendTip(cid, id)
	uint8_t id = popNumber(L);
...
int32_t LuaScriptInterface::luaDoSendPlayerPokemonLevelUp(lua_State* L)
{
	//doPlayerSendPokemonLevelUp(pokemonNumber, newLevel, newMoves)
	...
	while(lua_next(L, -2))
	{
        newMoves.push_back((uint16_t)lua_tonumber(L, -1));
		lua_pop(L, 1);
	}
	lua_pop(L, 1);
	
	uint8_t newLevel = popNumber(L);
	uint16_t pokemonNumber = popNumber(L);
    	
	ScriptEnviroment* env = getEnv();
	if(Player* player = env->getPlayerByUID(popNumber(L)))
	{
		player->sendPokemonLevelUp(pokemonNumber, newLevel, newMoves);
		lua_pushboolean(L, true);
	}
	else
	{
...
int32_t LuaScriptInterface::luaDoLocalization(lua_State* L)
{
	//__L(cid, str)
...
int32_t LuaScriptInterface::luaSetPlayerLanguage(lua_State* L)
{
...
int32_t LuaScriptInterface::luaGetPlayerLanguage(lua_State* L)
{
	//getPlayerLanguage(cid)
	ScriptEnviroment* env = getEnv();
	Player* player = env->getPlayerByUID(popNumber(L));
...
int32_t LuaScriptInterface::luaGetPlayerIsAfk(lua_State* L)
{
	//getPlayerIsAfk(cid)
	ScriptEnviroment* env = getEnv();
	Player* player = env->getPlayerByUID(popNumber(L));
    ...
    lua_pushboolean(L, player->getIsAfk());
    return 1;
}

int32_t LuaScriptInterface::luaSetPlayerIsAfk(lua_State* L)
{
	//setPlayerIsAfk(cid, value, message)
	std::string message = popString(L);
	uint32_t value = popBoolean(L);
	ScriptEnviroment* env = getEnv();
	
	if (Player* player = env->getPlayerByUID(popNumber(L))) {
		player->setIsAfk(value, message);
		lua_pushboolean(L, true);
	}
	else {
		errorEx(getError(LUA_ERROR_PLAYER_NOT_FOUND));
...
int32_t LuaScriptInterface::luaDoUpdateQuestMission(lua_State* L)
{
	//doUpdateQuestMission(storageid, npcName, npcOutfit, npcPosition, missionLevel)
	uint16_t missionLevel = popNumber(L);
	PositionEx npcPosition;
	popPosition(L, npcPosition);
	Outfit_t npcOutfit = popOutfit(L);
	std::string npcName = popString(L);
	uint32_t storageId = popNumber(L);
	
	Quests::getInstance()->updateQuestMission(storageId, npcName, npcOutfit, npcPosition, missionLevel);	
	return 1;
}
